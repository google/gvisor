...
*   **Participation**: Responsibilities within the project are earned through
    participation, and the path from contributor to maintainer is documented and
    open to anyone who meets it.
...
[MAINTAINERS.md](https://github.com/google/gvisor/tree/master/MAINTAINERS.md),
which is generated from
[`governance/maintainers.yaml`](https://github.com/google/gvisor/tree/master/governance/maintainers.yaml).
...
*   sustained commitment to the project, typically shown by:
    *   participating in discussions, contributions, and code and documentation
        reviews over a period of six months or more,
    *   reviewing a body of non-trivial pull requests,
    *   contributing non-trivial pull requests and having them merged,
...
[`governance/maintainers.yaml`](https://github.com/google/gvisor/tree/master/governance/maintainers.yaml),
granted the necessary GitHub rights, and offered access to the project's private
maintainer channels.
...
majority vote of existing maintainers, subject to
[org-balanced voting](#org-balanced-voting), provided they meet the current
...
The project holds public community meetings from time to time. They are
announced ahead of time via the
[gvisor-users](mailto:gvisor-users@googlegroups.com) mailing list and published
on the [community calendar](https://gvisor.dev/community/). Anyone can join.
Time zones permitting, maintainers are expected to participate.
...
**Resolving an impasse.** If the organizations split evenly, the individual
maintainers are counted instead, and the side with more maintainers behind it
wins. If both sides have the same number of maintainers, the proposal fails. For
this reason, maintainers record how each of them voted, not only how their
organization voted.
...
and rendered in
[MAINTAINERS.md](https://github.com/google/gvisor/tree/master/MAINTAINERS.md).
Independent contractors and self-employed contributors are each treated as their
own organization. Companies that own one another are treated as a single
organization. If a maintainer's affiliation is unclear, the Maintainer Council
will determine it.
