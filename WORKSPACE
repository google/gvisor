...
go_repository(
    ...
    sum = "h1:9J4xKbkPmH8l5DoM4dn2PglhfGIr+N8byJBZz4cjDUQ=",
    version = "v0.15.13-beta.0",
)
...
go_repository(
    ...
    sum = "h1:UoBeCd5U/znGf0yXHZckSfw4ncGOhURQj3PLgUY/dk0=",
    version = "v1.37.0-dev.0.20210303003404-c275c3599a6f",
)
