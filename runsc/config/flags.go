...
func RegisterFlags(flagSet *flag.FlagSet) {
	...
	flagSet.Int("network-processors-per-channel", 0, "number of goroutines in each channel for processing inbound packets. If 0, the link endpoint will divide GOMAXPROCS evenly among the number of channels specified by num-network-channels.")
