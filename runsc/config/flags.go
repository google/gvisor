...
func RegisterFlags(flagSet *flag.FlagSet) {
	...
	flagSet.Var(queueingDisciplinePtr(QDiscFIFO), "qdisc", `specifies which queueing discipline to apply by default to the non loopback nics used by the sandbox. One of "fifo" (default), "fifo_sync", or "none"`)
