...
```javascript
    Original bytecode                      New bytecode
00: 00: jeq 0, 99, 100           -->   00: jeq 0, 95, 96  // Updated
01: return allowed               -->   /* Removed */
02: return reject                -->   /* Removed */
...                                    ...
10: jge 0, 89, 90                -->   08: jge 0, 87, 88  // Updated
...
which is exactly what `seccomp-bpf` programs are — this approach massively
