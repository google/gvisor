...
func BenchmarkEncodingBinary(b *testing.B) {
	...
	for n := 0; n < b.N; n++ {
		...
		if err := binary.Write(buf, usermem.ByteOrder, &s1); err != nil {
			b.Error("Write:", err)
		}
		if err := binary.Read(buf, usermem.ByteOrder, &s2); err != nil {
			b.Error("Read:", err)
		}
	}
...
func BenchmarkMarshalManual(b *testing.B) {
	...
	for n := 0; n < b.N; n++ {
		...
		// Marshal
		off := 0
		usermem.ByteOrder.PutUint64(buf[off:], s1.Dev)
		off += 8
		usermem.ByteOrder.PutUint64(buf[off:], s1.Ino)
		off += 8
		usermem.ByteOrder.PutUint64(buf[off:], s1.Nlink)
		off += 8
		usermem.ByteOrder.PutUint32(buf[off:], s1.Mode)
		off += 4
		usermem.ByteOrder.PutUint32(buf[off:], s1.UID)
		off += 4
		usermem.ByteOrder.PutUint32(buf[off:], s1.GID)
		off += 4
		usermem.ByteOrder.PutUint32(buf[off:], 0)
		off += 4
		usermem.ByteOrder.PutUint64(buf[off:], s1.Rdev)
		off += 8
		usermem.ByteOrder.PutUint64(buf[off:], uint64(s1.Size))
		off += 8
		usermem.ByteOrder.PutUint64(buf[off:], uint64(s1.Blksize))
		off += 8
		usermem.ByteOrder.PutUint64(buf[off:], uint64(s1.Blocks))
		off += 8
		usermem.ByteOrder.PutUint64(buf[off:], uint64(s1.ATime.Sec))
		off += 8
		usermem.ByteOrder.PutUint64(buf[off:], uint64(s1.ATime.Nsec))
		off += 8
		usermem.ByteOrder.PutUint64(buf[off:], uint64(s1.MTime.Sec))
		off += 8
		usermem.ByteOrder.PutUint64(buf[off:], uint64(s1.MTime.Nsec))
		off += 8
		usermem.ByteOrder.PutUint64(buf[off:], uint64(s1.CTime.Sec))
		off += 8
		usermem.ByteOrder.PutUint64(buf[off:], uint64(s1.CTime.Nsec))
		off += 8
