...
func TestParseLine(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			data: "BenchmarkRuby/server_threads=1/clients=8-6 1	1397875880 ns/op	0.00710 average_latency.s 140 requests_per_second.QPS",
			want: &bigquery.Benchmark{
				Name: "BenchmarkRuby",
				Condition: []*bigquery.Condition{
					{
		...
		{
			name: "Value-less parameters",
			data: "BenchmarkRuby/server_threads/clients=8 1	1397875880 ns/op",
			want: &bigquery.Benchmark{
				Name: "BenchmarkRuby",
				Condition: []*bigquery.Condition{
					{
