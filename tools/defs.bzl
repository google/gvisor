...
load("//tools/bazeldefs:go.bzl", _cov_available = "cov_available", _gazelle = "gazelle", _go_binary = "go_binary", _go_binary_nogo_dep = "go_binary_nogo_dep", _go_cov = "go_cov", _go_grpc_and_proto_libraries = "go_grpc_and_proto_libraries", _go_imports = "go_imports", _go_library = "go_library", _go_path = "go_path", _go_proto_library = "go_proto_library", _go_test = "go_test", _gotsan_flag_values = "gotsan_flag_values", _gotsan_values = "gotsan_values", _select_goarch = "select_goarch", _select_goos = "select_goos")
...
def go_binary(name, nogo = True, pure = False, static = False, x_defs = None, **kwargs):
    ...
    if nogo:
        nogo_test(
            ...
            deps = [_go_binary_nogo_dep(name, noasan = kwargs.get("noasan", False))],
            tags = ["nogo"],
        )
