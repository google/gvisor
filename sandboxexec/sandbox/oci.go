...
type bundleConfig struct {
	...
	// SkipAPIFilesystemMounts omits the Linux API filesystem mounts, /proc and
	// /dev.
...
func newSpec(cfg bundleConfig) (*specs.Spec, error) {
	...
	if !cfg.SkipAPIFilesystemMounts {
...
func newBundle(cfg bundleConfig) (string, error) {
	...
	// Create the bundle directory, plus the root filesystem if there is none.
