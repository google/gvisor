...
// can be executed in it later. The path is absolute because the sandbox may
// well have been given no PATH to search, and it does mean that a sandbox has
// to have /bin/sleep in it to be created at all.
