...
The images used for each stack are in `images/compatibility/<application>`. The
application version under test is determined by the Dockerfile present in these
directories.
...
Soon the results from these tests will be listed on
