...
class KillSpecificReaperTest : public ::testing::TestWithParam<int (*)(void*)> {
};
...
TEST_P(KillSpecificReaperTest, KillSigterm) {
  ...
  ASSERT_THAT(
      child_pid = clone(GetParam(), reinterpret_cast<void*>(stack + stack_size),
...
INSTANTIATE_TEST_SUITE_P(KillReapers, KillSpecificReaperTest,
                         ::testing::Values(KillCannotTermReaper,
                                           KillCanTermNonReaper,
                                           KillCanTermReaperAction));
