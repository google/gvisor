...
TEST(NetlinkRouteTest, LinkMulticastGroupUserToUserSend) {
  ...
  recv_addr.nl_groups = RTMGRP_LINK;
  ...
  send_addr.nl_pid = 0;               // Send to the kernel.
  send_addr.nl_groups = RTMGRP_LINK;  // and also send to userland subscribers.
  struct msghdr msg = {};
  ...
  struct iovec iov = {};
  iov.iov_base = &mtu_request;
  iov.iov_len = sizeof(mtu_request);
  msg.msg_iov = &iov;
  msg.msg_iovlen = 1;
...
TEST(NetlinkRouteTest, LinkMulticastGroupCapNetAdmin) {
  ...
  send_addr.nl_family = AF_NETLINK;
  send_addr.nl_pid = 0;
  send_addr.nl_groups = RTMGRP_LINK;
...
TEST(NetlinkRouteTest, LinkMulticastGroupNoSelfBroadcast) {
  ...
  struct sockaddr_nl linkgrp_addr = {};
  linkgrp_addr.nl_family = AF_NETLINK;
  linkgrp_addr.nl_groups = RTMGRP_LINK;
