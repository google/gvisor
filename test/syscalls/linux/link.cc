...
TEST(LinkTest, HardlinkChangeMode) {
  ...
  // files inode are preserved after save/restore only if the file is
  // referenced. Do not use IsSameFile() here because it disables save before
  // checking the st_ino and st_dev.
