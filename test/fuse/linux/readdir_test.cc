...
TEST_F(ReaddirTest, SingleEntry) {
  ...
  size_t readdir_payload_size = test_file_dirent_size + dot_file_dirent_size + dot_dot_file_dirent_size;
  ...
  std::vector<char> readdir_payload_vec(readdir_payload, readdir_payload + readdir_payload_size);
