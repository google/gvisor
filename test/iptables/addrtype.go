...
// FilterInputAddrTypeLocalDrop tests kube-proxy's --dst-type LOCAL match:
// packets destined to an address assigned to the container must be LOCAL, not
// UNICAST. A classifier that labels ordinary addresses as UNICAST only will
// fail this test.
