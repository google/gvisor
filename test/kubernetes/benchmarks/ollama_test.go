...
func TestOllama(t *testing.T) {
	...
	k8sCtx.ForEachCluster(ctx, t, func(cluster *testcluster.TestCluster) {
		t.Run("Ollama", func(t *testing.T) {
			t.Parallel()
			doOllamaTest(ctx, t, k8sCtx, cluster)
		})
	})
}
...
// doOllamaTest runs ollama benchmarks for a single cluster.
func doOllamaTest(ctx context.Context, t *testing.T, k8sCtx k8sctx.KubernetesContext, cluster *testcluster.TestCluster) {
