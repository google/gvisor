...
func TestStableDiffusionXL(t *testing.T) {
	...
	k8sCtx.ForEachCluster(ctx, t, func(cluster *testcluster.TestCluster) {
		t.Run("stable_diffusion_xl", func(t *testing.T) {
			t.Parallel()
			doStableDiffusionXLTest(ctx, t, k8sCtx, cluster)
		})
	})
}
...
func doStableDiffusionXLTest(ctx context.Context, t *testing.T, k8sCtx k8sctx.KubernetesContext, cluster *testcluster.TestCluster) {
