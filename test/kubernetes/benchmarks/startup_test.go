...
// Package startup_test benchmarks the time it takes for an empty alpine container to complete successfully.
...
// TestStartup benchmarks the time it takes for an empty alpine container to complete successfully.
// Note: WRT gVisor startup latency, this is not a meaningful benchmark. Startup time is dominated
// by Kubernetes control plane API calls and not actual container startups. This benchmark is
