...
func TestTensorflowOnCPU(t *testing.T) {
	...
	k8sCtx.ForEachCluster(ctx, t, func(cluster *testcluster.TestCluster) {
		t.Run("TensorflowOnCPU", func(t *testing.T) {
			t.Parallel()
			doTensorflowOnCPU(ctx, t, k8sCtx, cluster)
		})
	})
}

func doTensorflowOnCPU(ctx context.Context, t *testing.T, k8sCtx k8sctx.KubernetesContext, cluster *testcluster.TestCluster) {
