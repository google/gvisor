...
func TestWordpress(t *testing.T) {
	...
	k8sCtx.ForEachCluster(ctx, t, func(cluster *testcluster.TestCluster) {
		t.Run("wordpress", func(t *testing.T) {
			t.Parallel()
			doWordpressTest(ctx, t, k8sCtx, cluster)
		})
	})
}

func doWordpressTest(ctx context.Context, t *testing.T, k8sCtx k8sctx.KubernetesContext, cluster *testcluster.TestCluster) {
