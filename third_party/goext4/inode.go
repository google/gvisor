...
// Inode flags.
const (
	InodeFlagSecrm     = 0x1  /* Secure deletion */
	InodeFlagUnrm      = 0x2  /* Undelete */
	InodeFlagCompr     = 0x4  /* Compress file */
	InodeFlagSync      = 0x8  /* Synchronous updates */
	InodeFlagImmutable = 0x10 /* Immutable file */
	InodeFlagAppend    = 0x20 /* writes to file may only append */
	InodeFlagNodump    = 0x40 /* do not dump file */
	InodeFlagNoatime   = 0x80 /* do not update atime */
	/* Reserved for compression usage... */
	InodeFlagDirty    = 0x100
	InodeFlagComprblk = 0x200 /* One or more compressed clusters */
	InodeFlagNocompr  = 0x400 /* Don't compress */
	InodeFlagEncrypt  = 0x800 /* encrypted file */
	/* End compression flags --- maybe not all used */
	InodeFlagIndex           = 0x1000   /* hash-indexed directory */
	InodeFlagImagic          = 0x2000   /* AFS directory */
	InodeFlagJournalData     = 0x4000   /* file data should be journaled */
	InodeFlagNotail          = 0x8000   /* file tail should not be merged */
	InodeFlagDirsync         = 0x10000  /* dirsync behaviour (directories only) */
	InodeFlagTopdir          = 0x20000  /* Top of directory hierarchies*/
	InodeFlagHugeFile        = 0x40000  /* Set to each huge file */
	InodeFlagExtents         = 0x80000  /* Inode uses extents */
	InodeFlagEaInode         = 0x200000 /* Inode used for large EA */
	InodeFlagEofblocks       = 0x400000 /* Blocks allocated beyond EOF */
	InodeFlagSnapfile        = 0x1000000
	InodeFlagSnapfileDeleted = 0x4000000
	InodeFlagSnapfileShrunk  = 0x8000000
	InodeFlagInlineData      = 0x10000000 /* Inode has inline data. */
	InodeFlagProjinherit     = 0x20000000 /* Create with parents projid */
	InodeFlagCasefold        = 0x40000000 /* Casefolded file */
	InodeFlagReserved        = 0x80000000 /* reserved for ext4 lib */
)
...
var (
	InodeFlagLookup = map[string]int{
		...
		"Casefold":        InodeFlagCasefold,
		"Rewserved":       InodeFlagReserved,
	}
)
