...
// versionSupportsTwalkopencreate returns true if version v supports the
// Twalkopen and Twalkcreate messages.
func versionSupportsTwalkopencreate(v uint32) bool {
	return v >= 13
}
