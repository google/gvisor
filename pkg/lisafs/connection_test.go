...
func runServerClient(t testing.TB, mountPath string, handlers []lisafs.RPCHandler, clientFn func(c *lisafs.Client)) {
...
var mountHandler lisafs.RPCHandler = func(c *lisafs.Connection, comm lisafs.Communicator, payloadLen uint32) (uint32, []int, error) {
...
func TestStartUp(t *testing.T) {
	mountPath := "/"
	var serverHandlers [3]lisafs.RPCHandler
...
func TestStress(t *testing.T) {
	...
	var dynamicMsgHandler lisafs.RPCHandler = func(c *lisafs.Connection, comm lisafs.Communicator, payloadLen uint32) (uint32, []int, error) {
	...
	var serverHandlers [4]lisafs.RPCHandler
	serverHandlers[lisafs.Error] = nil // No error handler needed.
	serverHandlers[lisafs.Mount] = mountHandler
	serverHandlers[lisafs.Channel] = lisafs.ChannelHandler
