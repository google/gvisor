...
34  | ConnectWithGroups | ConnectWithGroupsReq | Donates: \[sockFD\]                                                | ConnectWithGroups is Connect with the socket created and connected under the effective uid, gid and supplementary groups in ConnectWithGroupsReq. The server must provide a read concurrency guarantee on the file node during this operation.
