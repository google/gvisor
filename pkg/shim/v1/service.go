...
func (stm *shimTaskManager) Cleanup(ctx context.Context) (*shimapi.DeleteResponse, error) {
	log.L.Infof("Cleanup, id: %v", stm.id)
...
func (stm *shimTaskManager) StartShim(ctx context.Context, opts shim.StartOpts) (string, error) {
	log.L.Infof("StartShim, id: %v", opts.ID)
...
func New(ctx context.Context, id string, publisher shim.Publisher, fn func()) (shim.Shim, error) {
	...
	ts, err := newRunscService(ctx, id, publisher, fn)
	if err != nil {
		return nil, err
	}
...
// newRunscService creates a new runsc service that delegates to the runsc task service.
func newRunscService(ctx context.Context, id string, publisher shim.Publisher, cancel func()) (extension.TaskServiceExt, error) {
...
// runscService is the implementation of task service extension over gRPC/ttrpc. It
// is a intermediate layer between the containerd API and the runsc task service.
//
// It intercepts some calls to the task service like Create and forwards all calls
// to extension.TaskServiceExt which actually implements the service interface.
// This struct receives the RPC calls, forwards them to the
...
func (s *runscService) get() extension.TaskServiceExt {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *runscService) initExt(ctx context.Context, r *shimapi.CreateTaskRequest) error {
	s.mu.Lock()
	defer s.mu.Unlock()
...
// runtime.
func (s *runscService) Create(ctx context.Context, r *shimapi.CreateTaskRequest) (*shimapi.CreateTaskResponse, error) {
...
func (s *runscService) CreateWithFSRestore(ctx context.Context, r *extension.CreateWithFSRestoreRequest) (*shimapi.CreateTaskResponse, error) {
...
func (s *runscService) Start(ctx context.Context, r *shimapi.StartRequest) (*shimapi.StartResponse, error) {
...
func (s *runscService) Delete(ctx context.Context, r *shimapi.DeleteRequest) (*shimapi.DeleteResponse, error) {
...
func (s *runscService) Exec(ctx context.Context, r *shimapi.ExecProcessRequest) (*types.Empty, error) {
...
func (s *runscService) ResizePty(ctx context.Context, r *shimapi.ResizePtyRequest) (*types.Empty, error) {
...
func (s *runscService) State(ctx context.Context, r *shimapi.StateRequest) (*shimapi.StateResponse, error) {
...
// Pause the container.
func (s *runscService) Pause(ctx context.Context, r *shimapi.PauseRequest) (*types.Empty, error) {
...
func (s *runscService) Resume(ctx context.Context, r *shimapi.ResumeRequest) (*types.Empty, error) {
...
func (s *runscService) Kill(ctx context.Context, r *shimapi.KillRequest) (*types.Empty, error) {
...
func (s *runscService) Pids(ctx context.Context, r *shimapi.PidsRequest) (*shimapi.PidsResponse, error) {
...
func (s *runscService) CloseIO(ctx context.Context, r *shimapi.CloseIORequest) (*types.Empty, error) {
...
func (s *runscService) Checkpoint(ctx context.Context, r *shimapi.CheckpointTaskRequest) (*types.Empty, error) {
...
func (s *runscService) Connect(ctx context.Context, r *shimapi.ConnectRequest) (*shimapi.ConnectResponse, error) {
	log.L.Debugf("Connect, id: %s", r.ID)
	resp, err := s.get().Connect(ctx, r)
	return resp, errdefs.ToGRPC(err)
}

func (s *runscService) Shutdown(ctx context.Context, r *shimapi.ShutdownRequest) (*types.Empty, error) {
...
func (s *runscService) Stats(ctx context.Context, r *shimapi.StatsRequest) (*shimapi.StatsResponse, error) {
...
func (s *runscService) Update(ctx context.Context, r *shimapi.UpdateTaskRequest) (*types.Empty, error) {
...
func (s *runscService) Wait(ctx context.Context, r *shimapi.WaitRequest) (*shimapi.WaitResponse, error) {
...
// Checkpoint checkpoints the container.
func (s *runscService) Restore(ctx context.Context, r *extension.RestoreRequest) (*shimapi.StartResponse, error) {
