...
var _ marshal.Marshallable = (*NV0000_CTRL_OS_UNIX_MEMACCT_GET_LIMITS_PARAMS)(nil)
var _ marshal.Marshallable = (*NV0000_CTRL_OS_UNIX_MEMACCT_LIMITS)(nil)
...
var _ marshal.Marshallable = (*NV83DE_CTRL_DEBUG_READ_MEMORY_PARAMS)(nil)
...
var _ marshal.Marshallable = (*NVB1CC_ALLOC_PARAMETERS)(nil)
...
var _ marshal.Marshallable = (*NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS_V615)(nil)
...
var _ marshal.Marshallable = (*NV_EVENT_BUFFER_ALLOC_PARAMETERS)(nil)
...
// SizeBytes implements marshal.Marshallable.SizeBytes.
func (n *NVB1CC_ALLOC_PARAMETERS) SizeBytes() int {
    return 0 +
        (*Handle)(nil).SizeBytes()
}

// MarshalBytes implements marshal.Marshallable.MarshalBytes.
func (n *NVB1CC_ALLOC_PARAMETERS) MarshalBytes(dst []byte) []byte {
    dst = n.HSubDevice.MarshalUnsafe(dst)
    return dst
}

// UnmarshalBytes implements marshal.Marshallable.UnmarshalBytes.
func (n *NVB1CC_ALLOC_PARAMETERS) UnmarshalBytes(src []byte) []byte {
    src = n.HSubDevice.UnmarshalUnsafe(src)
    return src
}
...
// Packed implements marshal.Marshallable.Packed.
//go:nosplit
func (n *NVB1CC_ALLOC_PARAMETERS) Packed() bool {
    return n.HSubDevice.Packed()
}

// MarshalUnsafe implements marshal.Marshallable.MarshalUnsafe.
func (n *NVB1CC_ALLOC_PARAMETERS) MarshalUnsafe(dst []byte) []byte {
    if n.HSubDevice.Packed() {
        size := n.SizeBytes()
        gohacks.Memmove(unsafe.Pointer(&dst[0]), unsafe.Pointer(n), uintptr(size))
        return dst[size:]
    }
    // Type NVB1CC_ALLOC_PARAMETERS doesn't have a packed layout in memory, fallback to MarshalBytes.
    return n.MarshalBytes(dst)
}

// UnmarshalUnsafe implements marshal.Marshallable.UnmarshalUnsafe.
func (n *NVB1CC_ALLOC_PARAMETERS) UnmarshalUnsafe(src []byte) []byte {
    if n.HSubDevice.Packed() {
        size := n.SizeBytes()
        gohacks.Memmove(unsafe.Pointer(n), unsafe.Pointer(&src[0]), uintptr(size))
        return src[size:]
    }
    // Type NVB1CC_ALLOC_PARAMETERS doesn't have a packed layout in memory, fallback to UnmarshalBytes.
    return n.UnmarshalBytes(src)
}

// CopyOutN implements marshal.Marshallable.CopyOutN.
func (n *NVB1CC_ALLOC_PARAMETERS) CopyOutN(cc marshal.CopyContext, addr hostarch.Addr, limit int) (int, error) {
    if !n.HSubDevice.Packed() {
        // Type NVB1CC_ALLOC_PARAMETERS doesn't have a packed layout in memory, fall back to MarshalBytes.
        buf := cc.CopyScratchBuffer(n.SizeBytes()) // escapes: okay.
        n.MarshalBytes(buf) // escapes: fallback.
        return cc.CopyOutBytes(addr, buf[:limit]) // escapes: okay.
    }
...
// CopyOut implements marshal.Marshallable.CopyOut.
func (n *NVB1CC_ALLOC_PARAMETERS) CopyOut(cc marshal.CopyContext, addr hostarch.Addr) (int, error) {
    return n.CopyOutN(cc, addr, n.SizeBytes())
}

// CopyInN implements marshal.Marshallable.CopyInN.
func (n *NVB1CC_ALLOC_PARAMETERS) CopyInN(cc marshal.CopyContext, addr hostarch.Addr, limit int) (int, error) {
    if !n.HSubDevice.Packed() {
        // Type NVB1CC_ALLOC_PARAMETERS doesn't have a packed layout in memory, fall back to UnmarshalBytes.
        buf := cc.CopyScratchBuffer(n.SizeBytes()) // escapes: okay.
        length, err := cc.CopyInBytes(addr, buf[:limit]) // escapes: okay.
        // Unmarshal unconditionally. If we had a short copy-in, this results in a
        // partially unmarshalled struct.
...
// CopyIn implements marshal.Marshallable.CopyIn.
func (n *NVB1CC_ALLOC_PARAMETERS) CopyIn(cc marshal.CopyContext, addr hostarch.Addr) (int, error) {
    return n.CopyInN(cc, addr, n.SizeBytes())
}

// WriteTo implements io.WriterTo.WriteTo.
func (n *NVB1CC_ALLOC_PARAMETERS) WriteTo(writer io.Writer) (int64, error) {
    if !n.HSubDevice.Packed() {
        // Type NVB1CC_ALLOC_PARAMETERS doesn't have a packed layout in memory, fall back to MarshalBytes.
        buf := make([]byte, n.SizeBytes())
        n.MarshalBytes(buf)
...
// SizeBytes implements marshal.Marshallable.SizeBytes.
func (n *NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS_V615) SizeBytes() int {
    return 8 +
        (*NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS)(nil).SizeBytes()
}

// MarshalBytes implements marshal.Marshallable.MarshalBytes.
func (n *NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS_V615) MarshalBytes(dst []byte) []byte {
    dst = n.NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS.MarshalUnsafe(dst)
    hostarch.ByteOrder.PutUint32(dst[:4], uint32(n.Reserved))
    dst = dst[4:]
    hostarch.ByteOrder.PutUint32(dst[:4], uint32(n.InternalFlags))
    dst = dst[4:]
...
// UnmarshalBytes implements marshal.Marshallable.UnmarshalBytes.
func (n *NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS_V615) UnmarshalBytes(src []byte) []byte {
    src = n.NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS.UnmarshalUnsafe(src)
    n.Reserved = uint32(hostarch.ByteOrder.Uint32(src[:4]))
    src = src[4:]
    n.InternalFlags = uint32(hostarch.ByteOrder.Uint32(src[:4]))
    src = src[4:]
...
// Packed implements marshal.Marshallable.Packed.
//go:nosplit
func (n *NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS_V615) Packed() bool {
    return n.NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS.Packed()
}

// MarshalUnsafe implements marshal.Marshallable.MarshalUnsafe.
func (n *NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS_V615) MarshalUnsafe(dst []byte) []byte {
    if n.NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS.Packed() {
        size := n.SizeBytes()
        gohacks.Memmove(unsafe.Pointer(&dst[0]), unsafe.Pointer(n), uintptr(size))
        return dst[size:]
    }
    // Type NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS_V615 doesn't have a packed layout in memory, fallback to MarshalBytes.
    return n.MarshalBytes(dst)
}

// UnmarshalUnsafe implements marshal.Marshallable.UnmarshalUnsafe.
func (n *NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS_V615) UnmarshalUnsafe(src []byte) []byte {
    if n.NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS.Packed() {
        size := n.SizeBytes()
        gohacks.Memmove(unsafe.Pointer(n), unsafe.Pointer(&src[0]), uintptr(size))
        return src[size:]
    }
    // Type NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS_V615 doesn't have a packed layout in memory, fallback to UnmarshalBytes.
    return n.UnmarshalBytes(src)
}

// CopyOutN implements marshal.Marshallable.CopyOutN.
func (n *NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS_V615) CopyOutN(cc marshal.CopyContext, addr hostarch.Addr, limit int) (int, error) {
    if !n.NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS.Packed() {
        // Type NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS_V615 doesn't have a packed layout in memory, fall back to MarshalBytes.
        buf := cc.CopyScratchBuffer(n.SizeBytes()) // escapes: okay.
        n.MarshalBytes(buf) // escapes: fallback.
        return cc.CopyOutBytes(addr, buf[:limit]) // escapes: okay.
    }
...
// CopyOut implements marshal.Marshallable.CopyOut.
func (n *NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS_V615) CopyOut(cc marshal.CopyContext, addr hostarch.Addr) (int, error) {
    return n.CopyOutN(cc, addr, n.SizeBytes())
}

// CopyInN implements marshal.Marshallable.CopyInN.
func (n *NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS_V615) CopyInN(cc marshal.CopyContext, addr hostarch.Addr, limit int) (int, error) {
    if !n.NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS.Packed() {
        // Type NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS_V615 doesn't have a packed layout in memory, fall back to UnmarshalBytes.
        buf := cc.CopyScratchBuffer(n.SizeBytes()) // escapes: okay.
        length, err := cc.CopyInBytes(addr, buf[:limit]) // escapes: okay.
        // Unmarshal unconditionally. If we had a short copy-in, this results in a
        // partially unmarshalled struct.
...
// CopyIn implements marshal.Marshallable.CopyIn.
func (n *NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS_V615) CopyIn(cc marshal.CopyContext, addr hostarch.Addr) (int, error) {
    return n.CopyInN(cc, addr, n.SizeBytes())
}

// WriteTo implements io.WriterTo.WriteTo.
func (n *NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS_V615) WriteTo(writer io.Writer) (int64, error) {
    if !n.NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS.Packed() {
        // Type NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS_V615 doesn't have a packed layout in memory, fall back to MarshalBytes.
        buf := make([]byte, n.SizeBytes())
        n.MarshalBytes(buf)
...
// SizeBytes implements marshal.Marshallable.SizeBytes.
func (n *NV_EVENT_BUFFER_ALLOC_PARAMETERS) SizeBytes() int {
    return 32 +
        (*P64)(nil).SizeBytes() +
        (*P64)(nil).SizeBytes() +
        (*P64)(nil).SizeBytes() +
...
// MarshalBytes implements marshal.Marshallable.MarshalBytes.
func (n *NV_EVENT_BUFFER_ALLOC_PARAMETERS) MarshalBytes(dst []byte) []byte {
    dst = n.BufferHeader.MarshalUnsafe(dst)
    dst = n.RecordBuffer.MarshalUnsafe(dst)
    hostarch.ByteOrder.PutUint32(dst[:4], uint32(n.RecordSize))
    dst = dst[4:]
    hostarch.ByteOrder.PutUint32(dst[:4], uint32(n.RecordCount))
    dst = dst[4:]
    dst = n.VardataBuffer.MarshalUnsafe(dst)
    hostarch.ByteOrder.PutUint32(dst[:4], uint32(n.VardataBufferSize))
    dst = dst[4:]
    hostarch.ByteOrder.PutUint32(dst[:4], uint32(n.RecordsFreeThreshold))
    dst = dst[4:]
    hostarch.ByteOrder.PutUint64(dst[:8], uint64(n.NotificationHandle))
    dst = dst[8:]
    hostarch.ByteOrder.PutUint32(dst[:4], uint32(n.VardataFreeThreshold))
    dst = dst[4:]
    dst = n.HSubDevice.MarshalUnsafe(dst)
    hostarch.ByteOrder.PutUint32(dst[:4], uint32(n.Flags))
    dst = dst[4:]
    dst = n.HBufferHeader.MarshalUnsafe(dst)
    dst = n.HRecordBuffer.MarshalUnsafe(dst)
    dst = n.HVardataBuffer.MarshalUnsafe(dst)
    return dst
}

// UnmarshalBytes implements marshal.Marshallable.UnmarshalBytes.
func (n *NV_EVENT_BUFFER_ALLOC_PARAMETERS) UnmarshalBytes(src []byte) []byte {
    src = n.BufferHeader.UnmarshalUnsafe(src)
    src = n.RecordBuffer.UnmarshalUnsafe(src)
    n.RecordSize = uint32(hostarch.ByteOrder.Uint32(src[:4]))
    src = src[4:]
    n.RecordCount = uint32(hostarch.ByteOrder.Uint32(src[:4]))
    src = src[4:]
    src = n.VardataBuffer.UnmarshalUnsafe(src)
    n.VardataBufferSize = uint32(hostarch.ByteOrder.Uint32(src[:4]))
    src = src[4:]
    n.RecordsFreeThreshold = uint32(hostarch.ByteOrder.Uint32(src[:4]))
    src = src[4:]
    n.NotificationHandle = uint64(hostarch.ByteOrder.Uint64(src[:8]))
    src = src[8:]
    n.VardataFreeThreshold = uint32(hostarch.ByteOrder.Uint32(src[:4]))
    src = src[4:]
    src = n.HSubDevice.UnmarshalUnsafe(src)
    n.Flags = uint32(hostarch.ByteOrder.Uint32(src[:4]))
    src = src[4:]
    src = n.HBufferHeader.UnmarshalUnsafe(src)
    src = n.HRecordBuffer.UnmarshalUnsafe(src)
    src = n.HVardataBuffer.UnmarshalUnsafe(src)
    return src
}

// Packed implements marshal.Marshallable.Packed.
//go:nosplit
func (n *NV_EVENT_BUFFER_ALLOC_PARAMETERS) Packed() bool {
    return n.BufferHeader.Packed() && n.HBufferHeader.Packed() && n.HRecordBuffer.Packed() && n.HSubDevice.Packed() && n.HVardataBuffer.Packed() && n.RecordBuffer.Packed() && n.VardataBuffer.Packed()
}

// MarshalUnsafe implements marshal.Marshallable.MarshalUnsafe.
func (n *NV_EVENT_BUFFER_ALLOC_PARAMETERS) MarshalUnsafe(dst []byte) []byte {
    if n.BufferHeader.Packed() && n.HBufferHeader.Packed() && n.HRecordBuffer.Packed() && n.HSubDevice.Packed() && n.HVardataBuffer.Packed() && n.RecordBuffer.Packed() && n.VardataBuffer.Packed() {
        size := n.SizeBytes()
        gohacks.Memmove(unsafe.Pointer(&dst[0]), unsafe.Pointer(n), uintptr(size))
        return dst[size:]
    }
    // Type NV_EVENT_BUFFER_ALLOC_PARAMETERS doesn't have a packed layout in memory, fallback to MarshalBytes.
    return n.MarshalBytes(dst)
}

// UnmarshalUnsafe implements marshal.Marshallable.UnmarshalUnsafe.
func (n *NV_EVENT_BUFFER_ALLOC_PARAMETERS) UnmarshalUnsafe(src []byte) []byte {
    if n.BufferHeader.Packed() && n.HBufferHeader.Packed() && n.HRecordBuffer.Packed() && n.HSubDevice.Packed() && n.HVardataBuffer.Packed() && n.RecordBuffer.Packed() && n.VardataBuffer.Packed() {
        size := n.SizeBytes()
        gohacks.Memmove(unsafe.Pointer(n), unsafe.Pointer(&src[0]), uintptr(size))
        return src[size:]
    }
    // Type NV_EVENT_BUFFER_ALLOC_PARAMETERS doesn't have a packed layout in memory, fallback to UnmarshalBytes.
    return n.UnmarshalBytes(src)
}

// CopyOutN implements marshal.Marshallable.CopyOutN.
func (n *NV_EVENT_BUFFER_ALLOC_PARAMETERS) CopyOutN(cc marshal.CopyContext, addr hostarch.Addr, limit int) (int, error) {
    if !n.BufferHeader.Packed() && n.HBufferHeader.Packed() && n.HRecordBuffer.Packed() && n.HSubDevice.Packed() && n.HVardataBuffer.Packed() && n.RecordBuffer.Packed() && n.VardataBuffer.Packed() {
        // Type NV_EVENT_BUFFER_ALLOC_PARAMETERS doesn't have a packed layout in memory, fall back to MarshalBytes.
        buf := cc.CopyScratchBuffer(n.SizeBytes()) // escapes: okay.
        n.MarshalBytes(buf) // escapes: fallback.
        return cc.CopyOutBytes(addr, buf[:limit]) // escapes: okay.
    }
...
// CopyOut implements marshal.Marshallable.CopyOut.
func (n *NV_EVENT_BUFFER_ALLOC_PARAMETERS) CopyOut(cc marshal.CopyContext, addr hostarch.Addr) (int, error) {
    return n.CopyOutN(cc, addr, n.SizeBytes())
}

// CopyInN implements marshal.Marshallable.CopyInN.
func (n *NV_EVENT_BUFFER_ALLOC_PARAMETERS) CopyInN(cc marshal.CopyContext, addr hostarch.Addr, limit int) (int, error) {
    if !n.BufferHeader.Packed() && n.HBufferHeader.Packed() && n.HRecordBuffer.Packed() && n.HSubDevice.Packed() && n.HVardataBuffer.Packed() && n.RecordBuffer.Packed() && n.VardataBuffer.Packed() {
        // Type NV_EVENT_BUFFER_ALLOC_PARAMETERS doesn't have a packed layout in memory, fall back to UnmarshalBytes.
        buf := cc.CopyScratchBuffer(n.SizeBytes()) // escapes: okay.
        length, err := cc.CopyInBytes(addr, buf[:limit]) // escapes: okay.
        // Unmarshal unconditionally. If we had a short copy-in, this results in a
        // partially unmarshalled struct.
...
// CopyIn implements marshal.Marshallable.CopyIn.
func (n *NV_EVENT_BUFFER_ALLOC_PARAMETERS) CopyIn(cc marshal.CopyContext, addr hostarch.Addr) (int, error) {
    return n.CopyInN(cc, addr, n.SizeBytes())
}

// WriteTo implements io.WriterTo.WriteTo.
func (n *NV_EVENT_BUFFER_ALLOC_PARAMETERS) WriteTo(writer io.Writer) (int64, error) {
    if !n.BufferHeader.Packed() && n.HBufferHeader.Packed() && n.HRecordBuffer.Packed() && n.HSubDevice.Packed() && n.HVardataBuffer.Packed() && n.RecordBuffer.Packed() && n.VardataBuffer.Packed() {
        // Type NV_EVENT_BUFFER_ALLOC_PARAMETERS doesn't have a packed layout in memory, fall back to MarshalBytes.
        buf := make([]byte, n.SizeBytes())
        n.MarshalBytes(buf)
...
// SizeBytes implements marshal.Marshallable.SizeBytes.
func (n *NV0000_CTRL_OS_UNIX_MEMACCT_GET_LIMITS_PARAMS) SizeBytes() int {
    return 8 +
        (*NV0000_CTRL_OS_UNIX_MEMACCT_LIMITS)(nil).SizeBytes()*NV0000_CTRL_GPU_MAX_ATTACHED_GPUS
}

// MarshalBytes implements marshal.Marshallable.MarshalBytes.
func (n *NV0000_CTRL_OS_UNIX_MEMACCT_GET_LIMITS_PARAMS) MarshalBytes(dst []byte) []byte {
    hostarch.ByteOrder.PutUint32(dst[:4], uint32(n.CgroupFD))
    dst = dst[4:]
    hostarch.ByteOrder.PutUint32(dst[:4], uint32(n.Count))
    dst = dst[4:]
    for idx := 0; idx < NV0000_CTRL_GPU_MAX_ATTACHED_GPUS; idx++ {
        dst = n.Limits[idx].MarshalUnsafe(dst)
    }
    return dst
}

// UnmarshalBytes implements marshal.Marshallable.UnmarshalBytes.
func (n *NV0000_CTRL_OS_UNIX_MEMACCT_GET_LIMITS_PARAMS) UnmarshalBytes(src []byte) []byte {
    n.CgroupFD = int32(hostarch.ByteOrder.Uint32(src[:4]))
    src = src[4:]
    n.Count = uint32(hostarch.ByteOrder.Uint32(src[:4]))
    src = src[4:]
    for idx := 0; idx < NV0000_CTRL_GPU_MAX_ATTACHED_GPUS; idx++ {
        src = n.Limits[idx].UnmarshalUnsafe(src)
    }
    return src
}
...
// Packed implements marshal.Marshallable.Packed.
//go:nosplit
func (n *NV0000_CTRL_OS_UNIX_MEMACCT_GET_LIMITS_PARAMS) Packed() bool {
    return n.Limits[0].Packed()
}

// MarshalUnsafe implements marshal.Marshallable.MarshalUnsafe.
func (n *NV0000_CTRL_OS_UNIX_MEMACCT_GET_LIMITS_PARAMS) MarshalUnsafe(dst []byte) []byte {
    if n.Limits[0].Packed() {
        size := n.SizeBytes()
        gohacks.Memmove(unsafe.Pointer(&dst[0]), unsafe.Pointer(n), uintptr(size))
        return dst[size:]
    }
    // Type NV0000_CTRL_OS_UNIX_MEMACCT_GET_LIMITS_PARAMS doesn't have a packed layout in memory, fallback to MarshalBytes.
    return n.MarshalBytes(dst)
}

// UnmarshalUnsafe implements marshal.Marshallable.UnmarshalUnsafe.
func (n *NV0000_CTRL_OS_UNIX_MEMACCT_GET_LIMITS_PARAMS) UnmarshalUnsafe(src []byte) []byte {
    if n.Limits[0].Packed() {
        size := n.SizeBytes()
        gohacks.Memmove(unsafe.Pointer(n), unsafe.Pointer(&src[0]), uintptr(size))
        return src[size:]
    }
    // Type NV0000_CTRL_OS_UNIX_MEMACCT_GET_LIMITS_PARAMS doesn't have a packed layout in memory, fallback to UnmarshalBytes.
    return n.UnmarshalBytes(src)
}

// CopyOutN implements marshal.Marshallable.CopyOutN.
func (n *NV0000_CTRL_OS_UNIX_MEMACCT_GET_LIMITS_PARAMS) CopyOutN(cc marshal.CopyContext, addr hostarch.Addr, limit int) (int, error) {
    if !n.Limits[0].Packed() {
        // Type NV0000_CTRL_OS_UNIX_MEMACCT_GET_LIMITS_PARAMS doesn't have a packed layout in memory, fall back to MarshalBytes.
        buf := cc.CopyScratchBuffer(n.SizeBytes()) // escapes: okay.
        n.MarshalBytes(buf) // escapes: fallback.
        return cc.CopyOutBytes(addr, buf[:limit]) // escapes: okay.
    }
...
// CopyOut implements marshal.Marshallable.CopyOut.
func (n *NV0000_CTRL_OS_UNIX_MEMACCT_GET_LIMITS_PARAMS) CopyOut(cc marshal.CopyContext, addr hostarch.Addr) (int, error) {
    return n.CopyOutN(cc, addr, n.SizeBytes())
}

// CopyInN implements marshal.Marshallable.CopyInN.
func (n *NV0000_CTRL_OS_UNIX_MEMACCT_GET_LIMITS_PARAMS) CopyInN(cc marshal.CopyContext, addr hostarch.Addr, limit int) (int, error) {
    if !n.Limits[0].Packed() {
        // Type NV0000_CTRL_OS_UNIX_MEMACCT_GET_LIMITS_PARAMS doesn't have a packed layout in memory, fall back to UnmarshalBytes.
        buf := cc.CopyScratchBuffer(n.SizeBytes()) // escapes: okay.
        length, err := cc.CopyInBytes(addr, buf[:limit]) // escapes: okay.
        // Unmarshal unconditionally. If we had a short copy-in, this results in a
        // partially unmarshalled struct.
...
// CopyIn implements marshal.Marshallable.CopyIn.
func (n *NV0000_CTRL_OS_UNIX_MEMACCT_GET_LIMITS_PARAMS) CopyIn(cc marshal.CopyContext, addr hostarch.Addr) (int, error) {
    return n.CopyInN(cc, addr, n.SizeBytes())
}

// WriteTo implements io.WriterTo.WriteTo.
func (n *NV0000_CTRL_OS_UNIX_MEMACCT_GET_LIMITS_PARAMS) WriteTo(writer io.Writer) (int64, error) {
    if !n.Limits[0].Packed() {
        // Type NV0000_CTRL_OS_UNIX_MEMACCT_GET_LIMITS_PARAMS doesn't have a packed layout in memory, fall back to MarshalBytes.
        buf := make([]byte, n.SizeBytes())
        n.MarshalBytes(buf)
...
// SizeBytes implements marshal.Marshallable.SizeBytes.
func (n *NV0000_CTRL_OS_UNIX_MEMACCT_LIMITS) SizeBytes() int {
    return 28 +
        1*4
}

// MarshalBytes implements marshal.Marshallable.MarshalBytes.
func (n *NV0000_CTRL_OS_UNIX_MEMACCT_LIMITS) MarshalBytes(dst []byte) []byte {
    hostarch.ByteOrder.PutUint32(dst[:4], uint32(n.GpuID))
    dst = dst[4:]
    for idx := 0; idx < 4; idx++ {
    ...
    hostarch.ByteOrder.PutUint64(dst[:8], uint64(n.Soft))
    dst = dst[8:]
    hostarch.ByteOrder.PutUint64(dst[:8], uint64(n.Hard))
    dst = dst[8:]
    hostarch.ByteOrder.PutUint64(dst[:8], uint64(n.Current))
    dst = dst[8:]
    return dst
}

// UnmarshalBytes implements marshal.Marshallable.UnmarshalBytes.
func (n *NV0000_CTRL_OS_UNIX_MEMACCT_LIMITS) UnmarshalBytes(src []byte) []byte {
    n.GpuID = uint32(hostarch.ByteOrder.Uint32(src[:4]))
    src = src[4:]
    for idx := 0; idx < 4; idx++ {
        n.Pad[idx] = src[0]
    ...
    n.Soft = uint64(hostarch.ByteOrder.Uint64(src[:8]))
    src = src[8:]
    n.Hard = uint64(hostarch.ByteOrder.Uint64(src[:8]))
    src = src[8:]
    n.Current = uint64(hostarch.ByteOrder.Uint64(src[:8]))
    src = src[8:]
    return src
}
...
// Packed implements marshal.Marshallable.Packed.
//go:nosplit
func (n *NV0000_CTRL_OS_UNIX_MEMACCT_LIMITS) Packed() bool {
    return true
}

// MarshalUnsafe implements marshal.Marshallable.MarshalUnsafe.
func (n *NV0000_CTRL_OS_UNIX_MEMACCT_LIMITS) MarshalUnsafe(dst []byte) []byte {
    size := n.SizeBytes()
    gohacks.Memmove(unsafe.Pointer(&dst[0]), unsafe.Pointer(n), uintptr(size))
    return dst[size:]
}
...
// UnmarshalUnsafe implements marshal.Marshallable.UnmarshalUnsafe.
func (n *NV0000_CTRL_OS_UNIX_MEMACCT_LIMITS) UnmarshalUnsafe(src []byte) []byte {
    size := n.SizeBytes()
    gohacks.Memmove(unsafe.Pointer(n), unsafe.Pointer(&src[0]), uintptr(size))
    return src[size:]
}
...
// CopyOut implements marshal.Marshallable.CopyOut.
func (n *NV0000_CTRL_OS_UNIX_MEMACCT_LIMITS) CopyOut(cc marshal.CopyContext, addr hostarch.Addr) (int, error) {
    return n.CopyOutN(cc, addr, n.SizeBytes())
}
...
// CopyIn implements marshal.Marshallable.CopyIn.
func (n *NV0000_CTRL_OS_UNIX_MEMACCT_LIMITS) CopyIn(cc marshal.CopyContext, addr hostarch.Addr) (int, error) {
    return n.CopyInN(cc, addr, n.SizeBytes())
}
...
// SizeBytes implements marshal.Marshallable.SizeBytes.
func (n *NV83DE_CTRL_DEBUG_READ_MEMORY_PARAMS) SizeBytes() int {
    return 16 +
        (*P64)(nil).SizeBytes()
}

// MarshalBytes implements marshal.Marshallable.MarshalBytes.
func (n *NV83DE_CTRL_DEBUG_READ_MEMORY_PARAMS) MarshalBytes(dst []byte) []byte {
    hostarch.ByteOrder.PutUint32(dst[:4], uint32(n.HMemory))
    dst = dst[4:]
    hostarch.ByteOrder.PutUint32(dst[:4], uint32(n.Length))
    dst = dst[4:]
    hostarch.ByteOrder.PutUint64(dst[:8], uint64(n.Offset))
    dst = dst[8:]
    dst = n.Buffer.MarshalUnsafe(dst)
    return dst
}

// UnmarshalBytes implements marshal.Marshallable.UnmarshalBytes.
func (n *NV83DE_CTRL_DEBUG_READ_MEMORY_PARAMS) UnmarshalBytes(src []byte) []byte {
    n.HMemory = uint32(hostarch.ByteOrder.Uint32(src[:4]))
    src = src[4:]
    n.Length = uint32(hostarch.ByteOrder.Uint32(src[:4]))
    src = src[4:]
    n.Offset = uint64(hostarch.ByteOrder.Uint64(src[:8]))
    src = src[8:]
    src = n.Buffer.UnmarshalUnsafe(src)
    return src
}

// Packed implements marshal.Marshallable.Packed.
//go:nosplit
func (n *NV83DE_CTRL_DEBUG_READ_MEMORY_PARAMS) Packed() bool {
    return n.Buffer.Packed()
}

// MarshalUnsafe implements marshal.Marshallable.MarshalUnsafe.
func (n *NV83DE_CTRL_DEBUG_READ_MEMORY_PARAMS) MarshalUnsafe(dst []byte) []byte {
    if n.Buffer.Packed() {
        size := n.SizeBytes()
        gohacks.Memmove(unsafe.Pointer(&dst[0]), unsafe.Pointer(n), uintptr(size))
        return dst[size:]
    }
    // Type NV83DE_CTRL_DEBUG_READ_MEMORY_PARAMS doesn't have a packed layout in memory, fallback to MarshalBytes.
    return n.MarshalBytes(dst)
}

// UnmarshalUnsafe implements marshal.Marshallable.UnmarshalUnsafe.
func (n *NV83DE_CTRL_DEBUG_READ_MEMORY_PARAMS) UnmarshalUnsafe(src []byte) []byte {
    if n.Buffer.Packed() {
        size := n.SizeBytes()
        gohacks.Memmove(unsafe.Pointer(n), unsafe.Pointer(&src[0]), uintptr(size))
        return src[size:]
    }
    // Type NV83DE_CTRL_DEBUG_READ_MEMORY_PARAMS doesn't have a packed layout in memory, fallback to UnmarshalBytes.
    return n.UnmarshalBytes(src)
}

// CopyOutN implements marshal.Marshallable.CopyOutN.
func (n *NV83DE_CTRL_DEBUG_READ_MEMORY_PARAMS) CopyOutN(cc marshal.CopyContext, addr hostarch.Addr, limit int) (int, error) {
    if !n.Buffer.Packed() {
        // Type NV83DE_CTRL_DEBUG_READ_MEMORY_PARAMS doesn't have a packed layout in memory, fall back to MarshalBytes.
        buf := cc.CopyScratchBuffer(n.SizeBytes()) // escapes: okay.
        n.MarshalBytes(buf) // escapes: fallback.
        return cc.CopyOutBytes(addr, buf[:limit]) // escapes: okay.
    }
...
// CopyOut implements marshal.Marshallable.CopyOut.
func (n *NV83DE_CTRL_DEBUG_READ_MEMORY_PARAMS) CopyOut(cc marshal.CopyContext, addr hostarch.Addr) (int, error) {
    return n.CopyOutN(cc, addr, n.SizeBytes())
}

// CopyInN implements marshal.Marshallable.CopyInN.
func (n *NV83DE_CTRL_DEBUG_READ_MEMORY_PARAMS) CopyInN(cc marshal.CopyContext, addr hostarch.Addr, limit int) (int, error) {
    if !n.Buffer.Packed() {
        // Type NV83DE_CTRL_DEBUG_READ_MEMORY_PARAMS doesn't have a packed layout in memory, fall back to UnmarshalBytes.
        buf := cc.CopyScratchBuffer(n.SizeBytes()) // escapes: okay.
        length, err := cc.CopyInBytes(addr, buf[:limit]) // escapes: okay.
        // Unmarshal unconditionally. If we had a short copy-in, this results in a
        // partially unmarshalled struct.
...
// CopyIn implements marshal.Marshallable.CopyIn.
func (n *NV83DE_CTRL_DEBUG_READ_MEMORY_PARAMS) CopyIn(cc marshal.CopyContext, addr hostarch.Addr) (int, error) {
    return n.CopyInN(cc, addr, n.SizeBytes())
}

// WriteTo implements io.WriterTo.WriteTo.
func (n *NV83DE_CTRL_DEBUG_READ_MEMORY_PARAMS) WriteTo(writer io.Writer) (int64, error) {
    if !n.Buffer.Packed() {
        // Type NV83DE_CTRL_DEBUG_READ_MEMORY_PARAMS doesn't have a packed layout in memory, fall back to MarshalBytes.
        buf := make([]byte, n.SizeBytes())
        n.MarshalBytes(buf)
