...
// UVERBS_ATTR_DESTROY_MR_HANDLE is the handle attribute ID for uverbs_attrs_destroy_mr_cmd_attr_ids.
...
// UVERBS_ATTR_ASYNC_EVENT_ALLOC_FD_HANDLE is the handle attribute ID for uverbs_attrs_async_event_create.
