...
type CPUArchState struct {
	...
	// satpKvm is the value of satp for sentry.
	satpKvm uintptr

	// satpApp is the value of satp for application.
	satpApp uintptr
...
//go:nosplit
func (c *CPU) SetSatpKvm(value uintptr) {
	c.satpKvm = value
}
...
//go:nosplit
func (c *CPU) SetSatpApp(value uintptr) {
	c.satpApp = value
}
