...
// convertStatxToUserStat copies Statx fields into the LoongArch-flavoured
// Stat structure. LoongArch uses the asm-generic stat layout (same as
// arm64), so the body matches the arm64 version verbatim.
