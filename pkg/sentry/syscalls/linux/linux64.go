...
var AMD64 = &kernel.SyscallTable{
	...
	Table: map[uintptr]kernel.Syscall{
		...
		135: syscalls.PartiallySupported("personality", Personality, "Stub implementation. Only supports PER_LINUX.", nil),
...
var ARM64 = &kernel.SyscallTable{
	...
	Table: map[uintptr]kernel.Syscall{
		...
		92:  syscalls.PartiallySupported("personality", Personality, "Stub implementation. Only supports PER_LINUX.", nil),
