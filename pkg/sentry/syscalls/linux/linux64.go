...
var AMD64 = &kernel.SyscallTable{
	...
	Table: map[uintptr]kernel.Syscall{
		...
		66:  syscalls.PartiallySupported("semctl", Semctl, "Options IPC_INFO, SEM_INFO, SEM_STAT_ANY, GETNCNT not supported.", nil),
...
var ARM64 = &kernel.SyscallTable{
	...
	Table: map[uintptr]kernel.Syscall{
		...
		191: syscalls.PartiallySupported("semctl", Semctl, "Options IPC_INFO, SEM_INFO, SEM_STAT_ANY, GETNCNT not supported.", nil),
