...
var AMD64 = &kernel.SyscallTable{
	...
	Table: map[uintptr]kernel.Syscall{
		...
		68:  syscalls.ErrorWithEvent("msgget", linuxerr.ENOSYS, "", []string{"gvisor.dev/issue/135"}), // TODO(b/29354921)
		...
		71:  syscalls.ErrorWithEvent("msgctl", linuxerr.ENOSYS, "", []string{"gvisor.dev/issue/135"}), // TODO(b/29354921)
...
var ARM64 = &kernel.SyscallTable{
	...
	Table: map[uintptr]kernel.Syscall{
		...
		186: syscalls.ErrorWithEvent("msgget", linuxerr.ENOSYS, "", []string{"gvisor.dev/issue/135"}),          // TODO(b/29354921)
		187: syscalls.ErrorWithEvent("msgctl", linuxerr.ENOSYS, "", []string{"gvisor.dev/issue/135"}),          // TODO(b/29354921)
