...
// defaultReplicaMode is the mode of a replica when the mode mount option is
// absent. See fs/devpts/inode.c:DEVPTS_DEFAULT_MODE.
const defaultReplicaMode = linux.FileMode(0600)
