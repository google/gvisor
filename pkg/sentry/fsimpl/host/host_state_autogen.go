...
func (i *inode) StateSave(stateSinkObject state.Sink) {
	...
	stateSinkObject.Save(15, &i.restorable)
	stateSinkObject.Save(16, &i.readonly)
	stateSinkObject.Save(17, &i.devMinor)
	stateSinkObject.Save(18, &i.queue)
	stateSinkObject.Save(19, &i.virtualOwner)
	stateSinkObject.Save(20, &i.mappings)
	stateSinkObject.Save(21, &i.mmapFile)
	stateSinkObject.Save(22, &i.haveBuf)
	stateSinkObject.Save(23, &i.buf)
	stateSinkObject.Save(24, &i.tty)
	stateSinkObject.Save(25, &i.termios)
}
...
func (i *inode) StateLoad(ctx context.Context, stateSourceObject state.Source) {
	...
	stateSourceObject.Load(15, &i.restorable)
	stateSourceObject.Load(16, &i.readonly)
	stateSourceObject.Load(17, &i.devMinor)
	stateSourceObject.Load(18, &i.queue)
	stateSourceObject.Load(19, &i.virtualOwner)
	stateSourceObject.Load(20, &i.mappings)
	stateSourceObject.Load(21, &i.mmapFile)
	stateSourceObject.Load(22, &i.haveBuf)
	stateSourceObject.Load(23, &i.buf)
	stateSourceObject.Load(24, &i.tty)
	stateSourceObject.Load(25, &i.termios)
