...
func (i *inode) StateSave(stateSinkObject state.Sink) {
	...
	stateSinkObject.Save(5, &i.fs)
	stateSinkObject.Save(6, &i.nodeID)
	stateSinkObject.Save(7, &i.attrVersion)
	stateSinkObject.Save(8, &i.attrTime)
	stateSinkObject.Save(9, &i.link)
	stateSinkObject.Save(10, &i.fh)
	stateSinkObject.Save(11, &i.locks)
	stateSinkObject.Save(12, &i.watches)
	stateSinkObject.Save(13, &i.attrMu)
	stateSinkObject.Save(14, &i.ino)
	stateSinkObject.Save(15, &i.uid)
	stateSinkObject.Save(16, &i.gid)
	stateSinkObject.Save(17, &i.mode)
	stateSinkObject.Save(18, &i.atime)
	stateSinkObject.Save(19, &i.mtime)
	stateSinkObject.Save(20, &i.ctime)
	stateSinkObject.Save(21, &i.size)
	stateSinkObject.Save(22, &i.nlink)
	stateSinkObject.Save(23, &i.blockSize)
}
...
func (i *inode) StateLoad(stateSourceObject state.Source) {
	...
	stateSourceObject.Load(5, &i.fs)
	stateSourceObject.Load(6, &i.nodeID)
	stateSourceObject.Load(7, &i.attrVersion)
	stateSourceObject.Load(8, &i.attrTime)
	stateSourceObject.Load(9, &i.link)
	stateSourceObject.Load(10, &i.fh)
	stateSourceObject.Load(11, &i.locks)
	stateSourceObject.Load(12, &i.watches)
	stateSourceObject.Load(13, &i.attrMu)
	stateSourceObject.Load(14, &i.ino)
	stateSourceObject.Load(15, &i.uid)
	stateSourceObject.Load(16, &i.gid)
	stateSourceObject.Load(17, &i.mode)
	stateSourceObject.Load(18, &i.atime)
	stateSourceObject.Load(19, &i.mtime)
	stateSourceObject.Load(20, &i.ctime)
	stateSourceObject.Load(21, &i.size)
	stateSourceObject.Load(22, &i.nlink)
	stateSourceObject.Load(23, &i.blockSize)
}
