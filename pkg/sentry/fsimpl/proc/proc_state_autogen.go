...
func (i *subtasksInode) StateSave(stateSinkObject state.Sink) {
	...
	stateSinkObject.Save(10, &i.subtasksInodeRefs)
	stateSinkObject.Save(11, &i.locks)
	stateSinkObject.Save(12, &i.fs)
	stateSinkObject.Save(13, &i.task)
	stateSinkObject.Save(14, &i.pidns)
	stateSinkObject.Save(15, &i.cgroupControllers)
}
...
func (i *subtasksInode) StateLoad(ctx context.Context, stateSourceObject state.Source) {
	...
	stateSourceObject.Load(10, &i.subtasksInodeRefs)
	stateSourceObject.Load(11, &i.locks)
	stateSourceObject.Load(12, &i.fs)
	stateSourceObject.Load(13, &i.task)
	stateSourceObject.Load(14, &i.pidns)
	stateSourceObject.Load(15, &i.cgroupControllers)
}
...
func (i *taskInode) StateSave(stateSinkObject state.Sink) {
	...
	stateSinkObject.Save(11, &i.dentries)
}
...
func (i *taskInode) StateLoad(ctx context.Context, stateSourceObject state.Source) {
	...
	stateSourceObject.Load(11, &i.dentries)
}
...
func (i *fdDirInode) StateSave(stateSinkObject state.Sink) {
	...
	stateSinkObject.Save(11, &i.InodeFSOwned)
}
...
func (i *fdDirInode) StateLoad(ctx context.Context, stateSourceObject state.Source) {
	...
	stateSourceObject.Load(11, &i.InodeFSOwned)
}
...
func (s *fdSymlink) StateSave(stateSinkObject state.Sink) {
	...
	stateSinkObject.Save(7, &s.fs)
	stateSinkObject.Save(8, &s.task)
...
func (s *fdSymlink) StateLoad(ctx context.Context, stateSourceObject state.Source) {
	...
	stateSourceObject.Load(7, &s.fs)
	stateSourceObject.Load(8, &s.task)
...
func (f *memInode) StateLoad(ctx context.Context, stateSourceObject state.Source) {
	...
	stateSourceObject.Load(8, &f.task)
...
func (s *statusInode) StateSave(stateSinkObject state.Sink) {
	...
	stateSinkObject.Save(7, &s.InodeFSOwned)
	stateSinkObject.Save(8, &s.task)
	stateSinkObject.Save(9, &s.pidns)
...
func (s *statusInode) StateLoad(ctx context.Context, stateSourceObject state.Source) {
	...
	stateSourceObject.Load(7, &s.InodeFSOwned)
	stateSourceObject.Load(8, &s.task)
	stateSourceObject.Load(9, &s.pidns)
...
func (i *tasksInode) StateSave(stateSinkObject state.Sink) {
	...
	stateSinkObject.Save(8, &i.OrderedChildren)
	stateSinkObject.Save(9, &i.InodeFSOwned)
	stateSinkObject.Save(10, &i.tasksInodeRefs)
	stateSinkObject.Save(11, &i.locks)
	stateSinkObject.Save(12, &i.fs)
	stateSinkObject.Save(13, &i.pidns)
	stateSinkObject.Save(14, &i.fakeCgroupControllers)
}
...
func (i *tasksInode) StateLoad(ctx context.Context, stateSourceObject state.Source) {
	...
	stateSourceObject.Load(8, &i.OrderedChildren)
	stateSourceObject.Load(9, &i.InodeFSOwned)
	stateSourceObject.Load(10, &i.tasksInodeRefs)
	stateSourceObject.Load(11, &i.locks)
	stateSourceObject.Load(12, &i.fs)
...
func (s *selfSymlink) StateSave(stateSinkObject state.Sink) {
	...
	stateSinkObject.Save(5, &s.InodeWatches)
	stateSinkObject.Save(6, &s.InodeFSOwned)
	stateSinkObject.Save(7, &s.pidns)
}
...
func (s *selfSymlink) StateLoad(ctx context.Context, stateSourceObject state.Source) {
	...
	stateSourceObject.Load(5, &s.InodeWatches)
	stateSourceObject.Load(6, &s.InodeFSOwned)
	stateSourceObject.Load(7, &s.pidns)
}
...
func (d *domainnameData) StateTypeName() string {
	return "pkg/sentry/fsimpl/proc.domainnameData"
}

func (d *domainnameData) StateFields() []string {
	return []string{
		"DynamicBytesFile",
	}
}

func (d *domainnameData) beforeSave() {}

// +checklocksignore
func (d *domainnameData) StateSave(stateSinkObject state.Sink) {
	d.beforeSave()
	stateSinkObject.Save(0, &d.DynamicBytesFile)
}

func (d *domainnameData) afterLoad(context.Context) {}

// +checklocksignore
func (d *domainnameData) StateLoad(ctx context.Context, stateSourceObject state.Source) {
	stateSourceObject.Load(0, &d.DynamicBytesFile)
}
