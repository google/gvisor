...
type Manifest struct {
	...
	// checkpoint.
	//
	// TODO: Currently this must match during restore. Removing this requirement
	// involves at least stabilizing pgalloc's checkpoint format.
	RunscVersion string `json:"runsc_version,omitzero"`

	// PageSize is hostarch.PageSize for the sandbox that produced this
	// checkpoint.
	//
	// TODO: Currently this must match during restore. Technically, it's
	// already permissible for PageSize to shrink (as long as both old and new
	// sizes remain powers of 2). Allowing PageSize to increase may require
	...
	// checkpoint.
	//
	// TODO: Currently this must match during restore. Removing this
...
type Tmpfs struct {
	...
	//
	// TODO: Assign ResourceIDs to tmpfs filesystems directly so that we can
