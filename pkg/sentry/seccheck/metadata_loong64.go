...
// archInit registers syscall trace-points metadata. Syscall numbers come
// from the asm-generic uapi table, which LoongArch and arm64 share — so
// the contents below mirror metadata_arm64.go verbatim.
func archInit() {
	addSyscallPoint(19, "eventfd2", nil)
	addSyscallPoint(23, "dup", []FieldDesc{
		{ID: FieldSyscallPath, Name: "fd_path"},
	})
	...
	addSyscallPoint(221, "execve", []FieldDesc{
		{ID: FieldSyscallExecveEnvv, Name: "envv"},
	})
