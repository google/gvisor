...
func (s *memAcctSet) Remove(seg memAcctIterator) memAcctGapIterator {
	...
	return seg.node.rebalanceAfterRemove(memAcctGapIterator(seg))
}
...
func (s *memAcctSet) MoveFrom(s2 *memAcctSet) {
	*s = *s2
