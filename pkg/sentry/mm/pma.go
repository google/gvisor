						...
						if allocAR.IsHugePageAligned() {
							...
							if ok && startHugeRoundUp < endHugeRoundDown {
								...
								if allocAR.Start != startHugeRoundUp {
									// Shorten allocAR to the start of the first
									// full huge page, so that a later iteration of
									// this loop can allocate huge pages for the
									// hugepage-aligned subrange.
									allocAR.End = startHugeRoundUp
								} else {
									// Shorten allocAR to the end of the last full
									// huge page, so that a later iteration of this
									// loop can allocate small pages for the
									// sub-hugepage tail of allocAR.
