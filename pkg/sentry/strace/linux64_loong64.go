...
// linuxLoongArch64 provides a mapping of the Linux loong64 syscalls and
// their argument types for display / formatting. LoongArch uses the
// asm-generic syscall numbering, so this table is identical to the arm64
// table (linux64_arm64.go) save for the architecture identifier.
var linuxLoongArch64 = SyscallMap{
