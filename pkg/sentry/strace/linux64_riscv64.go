...
// linuxRISCV64 provides a mapping of the Linux riscv64 syscalls and their argument
// types for display / formatting.
var linuxRISCV64 = SyscallMap{
	...
	259: makeSyscallInfo("riscv_flush_icache", Hex, Hex, Hex),
	...
	416: makeSyscallInfo("io_pgetevents", Hex, Hex, Hex, Hex, Timespec, SigSet),
