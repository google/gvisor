...
//
//go:nosplit
func (r uint64Range) WellFormed() bool {
...
//
//go:nosplit
func (r uint64Range) Length() uint64 {
...
//
//go:nosplit
func (r uint64Range) Contains(x uint64) bool {
...
//
//go:nosplit
func (r uint64Range) Overlaps(r2 uint64Range) bool {
...
//
//go:nosplit
func (r uint64Range) IsSupersetOf(r2 uint64Range) bool {
...
//
//go:nosplit
func (r uint64Range) Intersect(r2 uint64Range) uint64Range {
	if r.Start < r2.Start {
		r.Start = r2.Start
	}
	if r.End > r2.End {
...
//
//go:nosplit
func (r uint64Range) CanSplitAt(x uint64) bool {
