...
func (e *connectionedEndpoint) BidirectionalConnect(ctx context.Context, ce ConnectingEndpoint, returnConnect func(Receiver, ConnectedEndpoint), opts UnixSocketOpts, kUidGidPtr *lisafs.KUIDGID) *syserr.Error {
	if ce.Type() != e.stype {
...
func (e *connectionedEndpoint) UnidirectionalConnect(ctx context.Context, opts UnixSocketOpts, kUidGidPtr *lisafs.KUIDGID) (ConnectedEndpoint, *syserr.Error) {
	return nil, syserr.ErrConnectionRefused
}

// Connect attempts to directly connect to another Endpoint.
// Implements Endpoint.Connect.
func (e *connectionedEndpoint) Connect(ctx context.Context, server BoundEndpoint, opts UnixSocketOpts, kUidGidPtr *lisafs.KUIDGID) *syserr.Error {
	...
	return server.BidirectionalConnect(ctx, e, returnConnect, opts, kUidGidPtr)
}
