...
//
// Process-group callers reach ts through the group's originator, but lock it
// through a task or PID namespace. checklocks cannot establish that these
// owners are the same or carry the held lock into child-group callbacks.
