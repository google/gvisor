...
func (s *idMapSet) Remove(seg idMapIterator) idMapGapIterator {
	...
	return seg.node.rebalanceAfterRemove(idMapGapIterator(seg))
}
...
func (s *idMapSet) RemoveRangeWith(r idMapRange, f func(seg idMapIterator)) idMapGapIterator {
	seg, gap := s.Find(r.Start)
	if seg.Ok() {
		seg = s.Isolate(seg, r)
		if f != nil {
...
// panics.
func (s *idMapSet) RemoveFullRangeWith(r idMapRange, f func(seg idMapIterator)) idMapGapIterator {
...
func (s *idMapSet) MoveFrom(s2 *idMapSet) {
	*s = *s2
