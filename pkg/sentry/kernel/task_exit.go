...
func (t *Task) exitChildrenLocked() {
	...
	// nil also means init is itself exiting, or a subreaper walk dead-ended.
	// Only a namespace that never had an init must survive, so test noInit
	// rather than nil alone.
