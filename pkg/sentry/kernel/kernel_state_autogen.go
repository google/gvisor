...
func (ns *CgroupNamespace) StateFields() []string {
	return []string{
		"root",
		"userns",
		"inode",
...
func (ns *CgroupNamespace) beforeSave() {}

// +checklocksignore
func (ns *CgroupNamespace) StateSave(stateSinkObject state.Sink) {
	ns.beforeSave()
	stateSinkObject.Save(0, &ns.root)
	stateSinkObject.Save(1, &ns.userns)
	stateSinkObject.Save(2, &ns.inode)
}

func (ns *CgroupNamespace) afterLoad(context.Context) {}

// +checklocksignore
func (ns *CgroupNamespace) StateLoad(ctx context.Context, stateSourceObject state.Source) {
	stateSourceObject.Load(0, &ns.root)
	stateSourceObject.Load(1, &ns.userns)
	stateSourceObject.Load(2, &ns.inode)
}
...
func (k *Kernel) StateSave(stateSinkObject state.Sink) {
	...
	stateSinkObject.SaveValue(25, danglingEndpointsValue)
	...
	stateSinkObject.Save(12, &k.rootCgroupNamespace)
	stateSinkObject.Save(13, &k.signalUnkillable)
	stateSinkObject.Save(14, &k.futexes)
	stateSinkObject.Save(15, &k.globalInit)
	stateSinkObject.Save(16, &k.syslog)
	stateSinkObject.Save(17, &k.runningTasks)
	stateSinkObject.Save(18, &k.cpuClockTickerRunning)
	stateSinkObject.Save(19, &k.cpuClock)
	stateSinkObject.Save(20, &k.userCPUClock)
	stateSinkObject.Save(21, &k.userSysCPUClock)
	stateSinkObject.Save(22, &k.uniqueID)
	stateSinkObject.Save(23, &k.nextInotifyCookie)
	stateSinkObject.Save(24, &k.netlinkPorts)
	stateSinkObject.Save(26, &k.sockets)
	...
	stateSinkObject.Save(32, &k.nsfsMount)
	stateSinkObject.Save(33, &k.shmMount)
	stateSinkObject.Save(34, &k.socketMount)
	stateSinkObject.Save(35, &k.sysVShmDevID)
	...
	stateSinkObject.Save(40, &k.cgroupMountsMap)
	stateSinkObject.Save(41, &k.userCountersMap)
	stateSinkObject.Save(42, &k.MaxFDLimit)
	stateSinkObject.Save(43, &k.containerNames)
	stateSinkObject.Save(44, &k.additionalCheckpointState)
	stateSinkObject.Save(45, &k.CheckpointWait)
	stateSinkObject.Save(46, &k.checkpointGen)
	stateSinkObject.Save(47, &k.SaveRestoreExecConfig)
	stateSinkObject.Save(48, &k.NvidiaDriverVersion)
	stateSinkObject.Save(49, &k.AllowSUID)
	stateSinkObject.Save(50, &k.IOUringEnabled)
	stateSinkObject.Save(51, &k.MaxKeySetSize)
	stateSinkObject.Save(52, &k.HostNamePoller)
	stateSinkObject.Save(53, &k.DomainNamePoller)
}
...
func (k *Kernel) StateLoad(ctx context.Context, stateSourceObject state.Source) {
	...
	stateSourceObject.Load(12, &k.rootCgroupNamespace)
	stateSourceObject.Load(13, &k.signalUnkillable)
	stateSourceObject.Load(14, &k.futexes)
	stateSourceObject.Load(15, &k.globalInit)
	stateSourceObject.Load(16, &k.syslog)
	stateSourceObject.Load(17, &k.runningTasks)
	stateSourceObject.Load(18, &k.cpuClockTickerRunning)
	stateSourceObject.Load(19, &k.cpuClock)
	stateSourceObject.Load(20, &k.userCPUClock)
	stateSourceObject.Load(21, &k.userSysCPUClock)
	stateSourceObject.Load(22, &k.uniqueID)
	stateSourceObject.Load(23, &k.nextInotifyCookie)
	stateSourceObject.Load(24, &k.netlinkPorts)
	stateSourceObject.Load(26, &k.sockets)
	...
	stateSourceObject.Load(32, &k.nsfsMount)
	stateSourceObject.Load(33, &k.shmMount)
	stateSourceObject.Load(34, &k.socketMount)
	stateSourceObject.Load(35, &k.sysVShmDevID)
	...
	stateSourceObject.Load(40, &k.cgroupMountsMap)
	stateSourceObject.Load(41, &k.userCountersMap)
	stateSourceObject.Load(42, &k.MaxFDLimit)
	stateSourceObject.Load(43, &k.containerNames)
	stateSourceObject.Load(44, &k.additionalCheckpointState)
	stateSourceObject.Load(45, &k.CheckpointWait)
	stateSourceObject.Load(46, &k.checkpointGen)
	stateSourceObject.Load(47, &k.SaveRestoreExecConfig)
	stateSourceObject.Load(48, &k.NvidiaDriverVersion)
	stateSourceObject.Load(49, &k.AllowSUID)
	stateSourceObject.Load(50, &k.IOUringEnabled)
	stateSourceObject.Load(51, &k.MaxKeySetSize)
	stateSourceObject.Load(52, &k.HostNamePoller)
	stateSourceObject.Load(53, &k.DomainNamePoller)
	stateSourceObject.LoadValue(25, new([]tcpip.Endpoint), func(y any) { k.loadDanglingEndpoints(ctx, y.([]tcpip.Endpoint)) })
}
...
func (t *Task) StateSave(stateSinkObject state.Sink) {
	...
	stateSinkObject.SaveValue(30, fsContextValue)
	vforkParentValue := t.saveVforkParent()
	_ = (*Task)(vforkParentValue)
	stateSinkObject.SaveValue(33, vforkParentValue)
	ptraceTracerValue := t.savePtraceTracer()
	_ = (*Task)(ptraceTracerValue)
	stateSinkObject.SaveValue(39, ptraceTracerValue)
	seccompValue := t.saveSeccomp()
	_ = (*taskSeccomp)(seccompValue)
	stateSinkObject.SaveValue(57, seccompValue)
	...
	stateSinkObject.Save(18, &t.freezeOrdered)
	stateSinkObject.Save(19, &t.hasFreezeCredit)
	stateSinkObject.Save(20, &t.freezeCreditCgroup)
	stateSinkObject.Save(21, &t.groupStopAcknowledged)
	stateSinkObject.Save(22, &t.trapStopPending)
	stateSinkObject.Save(23, &t.trapNotifyPending)
	stateSinkObject.Save(24, &t.stop)
	stateSinkObject.Save(25, &t.exitStatus)
	stateSinkObject.Save(26, &t.syscallRestartBlock)
	stateSinkObject.Save(27, &t.k)
	stateSinkObject.Save(28, &t.containerID)
	stateSinkObject.Save(29, &t.image)
	stateSinkObject.Save(31, &t.fdTable)
	stateSinkObject.Save(32, &t.userDumpable)
	stateSinkObject.Save(34, &t.exitState)
	stateSinkObject.Save(35, &t.exitTracerNotified)
	stateSinkObject.Save(36, &t.exitTracerAcked)
	stateSinkObject.Save(37, &t.exitParentNotified)
	stateSinkObject.Save(38, &t.exitParentAcked)
	stateSinkObject.Save(40, &t.ptraceTracees)
	stateSinkObject.Save(41, &t.ptraceSeized)
	stateSinkObject.Save(42, &t.ptraceOpts)
	stateSinkObject.Save(43, &t.ptraceSyscallMode)
	stateSinkObject.Save(44, &t.ptraceSinglestep)
	stateSinkObject.Save(45, &t.ptraceCode)
	stateSinkObject.Save(46, &t.ptraceSiginfo)
	stateSinkObject.Save(47, &t.ptraceEventMsg)
	stateSinkObject.Save(48, &t.ptraceYAMAExceptionAdded)
	stateSinkObject.Save(49, &t.ioUsage)
	stateSinkObject.Save(50, &t.creds)
	stateSinkObject.Save(51, &t.noNewPrivs)
	stateSinkObject.Save(52, &t.utsns)
	stateSinkObject.Save(53, &t.ipcns)
	stateSinkObject.Save(54, &t.cgroupns)
	stateSinkObject.Save(55, &t.mountNamespace)
	stateSinkObject.Save(56, &t.parentDeathSignal)
	stateSinkObject.Save(58, &t.cleartid)
	stateSinkObject.Save(59, &t.allowedCPUMask)
	stateSinkObject.Save(60, &t.cpu)
	stateSinkObject.Save(61, &t.scheduler)
	stateSinkObject.Save(62, &t.niceness)
	stateSinkObject.Save(63, &t.ioprio)
	stateSinkObject.Save(64, &t.numaPolicy)
	stateSinkObject.Save(65, &t.numaNodeMask)
	stateSinkObject.Save(66, &t.netns)
	stateSinkObject.Save(67, &t.rseqCPU)
	stateSinkObject.Save(68, &t.oldRSeqCPUAddr)
	stateSinkObject.Save(69, &t.rseqAddr)
	stateSinkObject.Save(70, &t.rseqSignature)
	stateSinkObject.Save(71, &t.robustList)
	stateSinkObject.Save(72, &t.startTime)
	stateSinkObject.Save(73, &t.kcov)
	stateSinkObject.Save(74, &t.cgroups)
	stateSinkObject.Save(75, &t.cgroup2)
	stateSinkObject.Save(76, &t.memCgID)
	stateSinkObject.Save(77, &t.userCounters)
	stateSinkObject.Save(78, &t.sessionKeyring)
	stateSinkObject.Save(79, &t.personality)
	stateSinkObject.Save(80, &t.Origin)
	stateSinkObject.Save(81, &t.onDestroyAction)
	stateSinkObject.Save(82, &t.execveCredsMutexOwner)
	stateSinkObject.Save(83, &t.pid)
}
...
func (t *Task) StateLoad(ctx context.Context, stateSourceObject state.Source) {
	...
	stateSourceObject.Load(18, &t.freezeOrdered)
	stateSourceObject.Load(19, &t.hasFreezeCredit)
	stateSourceObject.Load(20, &t.freezeCreditCgroup)
	stateSourceObject.Load(21, &t.groupStopAcknowledged)
	stateSourceObject.Load(22, &t.trapStopPending)
	stateSourceObject.Load(23, &t.trapNotifyPending)
	stateSourceObject.Load(24, &t.stop)
	stateSourceObject.Load(25, &t.exitStatus)
	stateSourceObject.Load(26, &t.syscallRestartBlock)
	stateSourceObject.Load(27, &t.k)
	stateSourceObject.Load(28, &t.containerID)
	stateSourceObject.Load(29, &t.image)
	stateSourceObject.Load(31, &t.fdTable)
	stateSourceObject.Load(32, &t.userDumpable)
	stateSourceObject.Load(34, &t.exitState)
	stateSourceObject.Load(35, &t.exitTracerNotified)
	stateSourceObject.Load(36, &t.exitTracerAcked)
	stateSourceObject.Load(37, &t.exitParentNotified)
	stateSourceObject.Load(38, &t.exitParentAcked)
	stateSourceObject.Load(40, &t.ptraceTracees)
	stateSourceObject.Load(41, &t.ptraceSeized)
	stateSourceObject.Load(42, &t.ptraceOpts)
	stateSourceObject.Load(43, &t.ptraceSyscallMode)
	stateSourceObject.Load(44, &t.ptraceSinglestep)
	stateSourceObject.Load(45, &t.ptraceCode)
	stateSourceObject.Load(46, &t.ptraceSiginfo)
	stateSourceObject.Load(47, &t.ptraceEventMsg)
	stateSourceObject.Load(48, &t.ptraceYAMAExceptionAdded)
	stateSourceObject.Load(49, &t.ioUsage)
	stateSourceObject.Load(50, &t.creds)
	stateSourceObject.Load(51, &t.noNewPrivs)
	stateSourceObject.Load(52, &t.utsns)
	stateSourceObject.Load(53, &t.ipcns)
	stateSourceObject.Load(54, &t.cgroupns)
	stateSourceObject.Load(55, &t.mountNamespace)
	stateSourceObject.Load(56, &t.parentDeathSignal)
	stateSourceObject.Load(58, &t.cleartid)
	stateSourceObject.Load(59, &t.allowedCPUMask)
	stateSourceObject.Load(60, &t.cpu)
	stateSourceObject.Load(61, &t.scheduler)
	stateSourceObject.Load(62, &t.niceness)
	stateSourceObject.Load(63, &t.ioprio)
	stateSourceObject.Load(64, &t.numaPolicy)
	stateSourceObject.Load(65, &t.numaNodeMask)
	stateSourceObject.Load(66, &t.netns)
	stateSourceObject.Load(67, &t.rseqCPU)
	stateSourceObject.Load(68, &t.oldRSeqCPUAddr)
	stateSourceObject.Load(69, &t.rseqAddr)
	stateSourceObject.Load(70, &t.rseqSignature)
	stateSourceObject.Load(71, &t.robustList)
	stateSourceObject.Load(72, &t.startTime)
	stateSourceObject.Load(73, &t.kcov)
	stateSourceObject.Load(74, &t.cgroups)
	stateSourceObject.Load(75, &t.cgroup2)
	stateSourceObject.Load(76, &t.memCgID)
	stateSourceObject.Load(77, &t.userCounters)
	stateSourceObject.Load(78, &t.sessionKeyring)
	stateSourceObject.Load(79, &t.personality)
	stateSourceObject.Load(80, &t.Origin)
	stateSourceObject.Load(81, &t.onDestroyAction)
	stateSourceObject.Load(82, &t.execveCredsMutexOwner)
	stateSourceObject.Load(83, &t.pid)
	stateSourceObject.LoadValue(30, new(*FSContext), func(y any) { t.loadFsContext(ctx, y.(*FSContext)) })
	stateSourceObject.LoadValue(33, new(*Task), func(y any) { t.loadVforkParent(ctx, y.(*Task)) })
	stateSourceObject.LoadValue(39, new(*Task), func(y any) { t.loadPtraceTracer(ctx, y.(*Task)) })
	stateSourceObject.LoadValue(57, new(*taskSeccomp), func(y any) { t.loadSeccomp(ctx, y.(*taskSeccomp)) })
...
func (f *frozenStop) StateTypeName() string {
	return "pkg/sentry/kernel.frozenStop"
}

func (f *frozenStop) StateFields() []string {
	return []string{}
}

func (f *frozenStop) beforeSave() {}

// +checklocksignore
func (f *frozenStop) StateSave(stateSinkObject state.Sink) {
	f.beforeSave()
}

func (f *frozenStop) afterLoad(context.Context) {}

// +checklocksignore
func (f *frozenStop) StateLoad(ctx context.Context, stateSourceObject state.Source) {
}
