...
func (t *Task) StateSave(stateSinkObject state.Sink) {
	...
	stateSinkObject.SaveValue(53, seccompValue)
	...
	stateSinkObject.Save(50, &t.cgroupns)
	stateSinkObject.Save(51, &t.mountNamespace)
	stateSinkObject.Save(52, &t.parentDeathSignal)
	stateSinkObject.Save(54, &t.cleartid)
	stateSinkObject.Save(55, &t.allowedCPUMask)
	stateSinkObject.Save(56, &t.cpu)
	stateSinkObject.Save(57, &t.scheduler)
	stateSinkObject.Save(58, &t.niceness)
	stateSinkObject.Save(59, &t.ioprio)
	stateSinkObject.Save(60, &t.numaPolicy)
	stateSinkObject.Save(61, &t.numaNodeMask)
	stateSinkObject.Save(62, &t.netns)
	stateSinkObject.Save(63, &t.rseqCPU)
	stateSinkObject.Save(64, &t.oldRSeqCPUAddr)
	stateSinkObject.Save(65, &t.rseqAddr)
	stateSinkObject.Save(66, &t.rseqSignature)
	stateSinkObject.Save(67, &t.robustList)
	stateSinkObject.Save(68, &t.startTime)
	stateSinkObject.Save(69, &t.kcov)
	stateSinkObject.Save(70, &t.cgroups)
	stateSinkObject.Save(71, &t.cgroup2)
	stateSinkObject.Save(72, &t.memCgID)
	stateSinkObject.Save(73, &t.userCounters)
	stateSinkObject.Save(74, &t.sessionKeyring)
	stateSinkObject.Save(75, &t.personality)
	stateSinkObject.Save(76, &t.Origin)
	stateSinkObject.Save(77, &t.onDestroyAction)
	stateSinkObject.Save(78, &t.execveCredsMutexOwner)
	stateSinkObject.Save(79, &t.pid)
}
...
func (t *Task) StateLoad(ctx context.Context, stateSourceObject state.Source) {
	...
	stateSourceObject.Load(50, &t.cgroupns)
	stateSourceObject.Load(51, &t.mountNamespace)
	stateSourceObject.Load(52, &t.parentDeathSignal)
	stateSourceObject.Load(54, &t.cleartid)
	stateSourceObject.Load(55, &t.allowedCPUMask)
	stateSourceObject.Load(56, &t.cpu)
	stateSourceObject.Load(57, &t.scheduler)
	stateSourceObject.Load(58, &t.niceness)
	stateSourceObject.Load(59, &t.ioprio)
	stateSourceObject.Load(60, &t.numaPolicy)
	stateSourceObject.Load(61, &t.numaNodeMask)
	stateSourceObject.Load(62, &t.netns)
	stateSourceObject.Load(63, &t.rseqCPU)
	stateSourceObject.Load(64, &t.oldRSeqCPUAddr)
	stateSourceObject.Load(65, &t.rseqAddr)
	stateSourceObject.Load(66, &t.rseqSignature)
	stateSourceObject.Load(67, &t.robustList)
	stateSourceObject.Load(68, &t.startTime)
	stateSourceObject.Load(69, &t.kcov)
	stateSourceObject.Load(70, &t.cgroups)
	stateSourceObject.Load(71, &t.cgroup2)
	stateSourceObject.Load(72, &t.memCgID)
	stateSourceObject.Load(73, &t.userCounters)
	stateSourceObject.Load(74, &t.sessionKeyring)
	stateSourceObject.Load(75, &t.personality)
	stateSourceObject.Load(76, &t.Origin)
	stateSourceObject.Load(77, &t.onDestroyAction)
	stateSourceObject.Load(78, &t.execveCredsMutexOwner)
	stateSourceObject.Load(79, &t.pid)
	...
	stateSourceObject.LoadValue(53, new(*taskSeccomp), func(y any) { t.loadSeccomp(ctx, y.(*taskSeccomp)) })
