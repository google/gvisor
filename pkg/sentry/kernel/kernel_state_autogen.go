...
func (k *Kernel) StateSave(stateSinkObject state.Sink) {
	...
	stateSinkObject.Save(13, &k.futexes)
	stateSinkObject.Save(14, &k.globalInit)
	stateSinkObject.Save(15, &k.syslog)
	stateSinkObject.Save(16, &k.runningTasks)
	stateSinkObject.Save(17, &k.cpuClockTickerRunning)
	stateSinkObject.Save(18, &k.cpuClock)
	stateSinkObject.Save(19, &k.userCPUClock)
	stateSinkObject.Save(20, &k.userSysCPUClock)
	...
	stateSinkObject.Save(26, &k.nextSocketRecord)
	stateSinkObject.Save(27, &k.SpecialOpts)
	stateSinkObject.Save(28, &k.vfs)
	stateSinkObject.Save(29, &k.hostMount)
	stateSinkObject.Save(30, &k.pipeMount)
	stateSinkObject.Save(31, &k.nsfsMount)
	stateSinkObject.Save(32, &k.shmMount)
	stateSinkObject.Save(33, &k.socketMount)
	stateSinkObject.Save(34, &k.sysVShmDevID)
	stateSinkObject.Save(35, &k.SleepForAddressSpaceActivation)
	stateSinkObject.Save(36, &k.ptraceExceptions)
	stateSinkObject.Save(37, &k.YAMAPtraceScope)
	stateSinkObject.Save(38, &k.cgroupRegistry)
	stateSinkObject.Save(39, &k.cgroupMountsMap)
	stateSinkObject.Save(40, &k.userCountersMap)
	stateSinkObject.Save(41, &k.MaxFDLimit)
	stateSinkObject.Save(42, &k.containerNames)
	stateSinkObject.Save(43, &k.additionalCheckpointState)
	stateSinkObject.Save(44, &k.CheckpointWait)
	stateSinkObject.Save(45, &k.checkpointGen)
	stateSinkObject.Save(46, &k.SaveRestoreExecConfig)
	stateSinkObject.Save(47, &k.NvidiaDriverVersion)
	stateSinkObject.Save(48, &k.AllowSUID)
	stateSinkObject.Save(49, &k.IOUringEnabled)
	stateSinkObject.Save(50, &k.MaxKeySetSize)
	stateSinkObject.Save(51, &k.HostNamePoller)
	stateSinkObject.Save(52, &k.DomainNamePoller)
}
...
func (k *Kernel) StateLoad(ctx context.Context, stateSourceObject state.Source) {
	...
	stateSourceObject.Load(13, &k.futexes)
	stateSourceObject.Load(14, &k.globalInit)
	stateSourceObject.Load(15, &k.syslog)
	stateSourceObject.Load(16, &k.runningTasks)
	stateSourceObject.Load(17, &k.cpuClockTickerRunning)
	stateSourceObject.Load(18, &k.cpuClock)
	stateSourceObject.Load(19, &k.userCPUClock)
	stateSourceObject.Load(20, &k.userSysCPUClock)
	...
	stateSourceObject.Load(26, &k.nextSocketRecord)
	stateSourceObject.Load(27, &k.SpecialOpts)
	stateSourceObject.Load(28, &k.vfs)
	stateSourceObject.Load(29, &k.hostMount)
	stateSourceObject.Load(30, &k.pipeMount)
	stateSourceObject.Load(31, &k.nsfsMount)
	stateSourceObject.Load(32, &k.shmMount)
	stateSourceObject.Load(33, &k.socketMount)
	stateSourceObject.Load(34, &k.sysVShmDevID)
	stateSourceObject.Load(35, &k.SleepForAddressSpaceActivation)
	stateSourceObject.Load(36, &k.ptraceExceptions)
	stateSourceObject.Load(37, &k.YAMAPtraceScope)
	stateSourceObject.Load(38, &k.cgroupRegistry)
	stateSourceObject.Load(39, &k.cgroupMountsMap)
	stateSourceObject.Load(40, &k.userCountersMap)
	stateSourceObject.Load(41, &k.MaxFDLimit)
	stateSourceObject.Load(42, &k.containerNames)
	stateSourceObject.Load(43, &k.additionalCheckpointState)
	stateSourceObject.Load(44, &k.CheckpointWait)
	stateSourceObject.Load(45, &k.checkpointGen)
	stateSourceObject.Load(46, &k.SaveRestoreExecConfig)
	stateSourceObject.Load(47, &k.NvidiaDriverVersion)
	stateSourceObject.Load(48, &k.AllowSUID)
	stateSourceObject.Load(49, &k.IOUringEnabled)
	stateSourceObject.Load(50, &k.MaxKeySetSize)
	stateSourceObject.Load(51, &k.HostNamePoller)
	stateSourceObject.Load(52, &k.DomainNamePoller)
	stateSourceObject.LoadValue(24, new([]tcpip.Endpoint), func(y any) { k.loadDanglingEndpoints(ctx, y.([]tcpip.Endpoint)) })
}
...
func (t *Task) StateSave(stateSinkObject state.Sink) {
	...
	stateSinkObject.SaveValue(30, vforkParentValue)
	ptraceTracerValue := t.savePtraceTracer()
	_ = (*Task)(ptraceTracerValue)
	stateSinkObject.SaveValue(36, ptraceTracerValue)
	seccompValue := t.saveSeccomp()
	_ = (*taskSeccomp)(seccompValue)
	stateSinkObject.SaveValue(54, seccompValue)
	...
	stateSinkObject.Save(29, &t.userDumpable)
	stateSinkObject.Save(31, &t.exitState)
	stateSinkObject.Save(32, &t.exitTracerNotified)
	stateSinkObject.Save(33, &t.exitTracerAcked)
	stateSinkObject.Save(34, &t.exitParentNotified)
	stateSinkObject.Save(35, &t.exitParentAcked)
	stateSinkObject.Save(37, &t.ptraceTracees)
	stateSinkObject.Save(38, &t.ptraceSeized)
	stateSinkObject.Save(39, &t.ptraceOpts)
	stateSinkObject.Save(40, &t.ptraceSyscallMode)
	stateSinkObject.Save(41, &t.ptraceSinglestep)
	stateSinkObject.Save(42, &t.ptraceCode)
	stateSinkObject.Save(43, &t.ptraceSiginfo)
	stateSinkObject.Save(44, &t.ptraceEventMsg)
	stateSinkObject.Save(45, &t.ptraceYAMAExceptionAdded)
	stateSinkObject.Save(46, &t.ioUsage)
	stateSinkObject.Save(47, &t.creds)
	stateSinkObject.Save(48, &t.noNewPrivs)
	stateSinkObject.Save(49, &t.utsns)
	stateSinkObject.Save(50, &t.ipcns)
	stateSinkObject.Save(51, &t.cgroupns)
	stateSinkObject.Save(52, &t.mountNamespace)
	stateSinkObject.Save(53, &t.parentDeathSignal)
	stateSinkObject.Save(55, &t.cleartid)
	stateSinkObject.Save(56, &t.allowedCPUMask)
	stateSinkObject.Save(57, &t.cpu)
	stateSinkObject.Save(58, &t.scheduler)
	stateSinkObject.Save(59, &t.niceness)
	stateSinkObject.Save(60, &t.ioprio)
	stateSinkObject.Save(61, &t.numaPolicy)
	stateSinkObject.Save(62, &t.numaNodeMask)
	stateSinkObject.Save(63, &t.netns)
	stateSinkObject.Save(64, &t.rseqCPU)
	stateSinkObject.Save(65, &t.oldRSeqCPUAddr)
	stateSinkObject.Save(66, &t.rseqAddr)
	stateSinkObject.Save(67, &t.rseqSignature)
	stateSinkObject.Save(68, &t.robustList)
	stateSinkObject.Save(69, &t.startTime)
	stateSinkObject.Save(70, &t.kcov)
	stateSinkObject.Save(71, &t.cgroups)
	stateSinkObject.Save(72, &t.cgroup2)
	stateSinkObject.Save(73, &t.memCgID)
	stateSinkObject.Save(74, &t.userCounters)
	stateSinkObject.Save(75, &t.sessionKeyring)
	stateSinkObject.Save(76, &t.personality)
	stateSinkObject.Save(77, &t.Origin)
	stateSinkObject.Save(78, &t.onDestroyAction)
	stateSinkObject.Save(79, &t.execveCredsMutexOwner)
	stateSinkObject.Save(80, &t.pid)
}
...
func (t *Task) StateLoad(ctx context.Context, stateSourceObject state.Source) {
	...
	stateSourceObject.Load(29, &t.userDumpable)
	stateSourceObject.Load(31, &t.exitState)
	stateSourceObject.Load(32, &t.exitTracerNotified)
	stateSourceObject.Load(33, &t.exitTracerAcked)
	stateSourceObject.Load(34, &t.exitParentNotified)
	stateSourceObject.Load(35, &t.exitParentAcked)
	stateSourceObject.Load(37, &t.ptraceTracees)
	stateSourceObject.Load(38, &t.ptraceSeized)
	stateSourceObject.Load(39, &t.ptraceOpts)
	stateSourceObject.Load(40, &t.ptraceSyscallMode)
	stateSourceObject.Load(41, &t.ptraceSinglestep)
	stateSourceObject.Load(42, &t.ptraceCode)
	stateSourceObject.Load(43, &t.ptraceSiginfo)
	stateSourceObject.Load(44, &t.ptraceEventMsg)
	stateSourceObject.Load(45, &t.ptraceYAMAExceptionAdded)
	stateSourceObject.Load(46, &t.ioUsage)
	stateSourceObject.Load(47, &t.creds)
	stateSourceObject.Load(48, &t.noNewPrivs)
	stateSourceObject.Load(49, &t.utsns)
	stateSourceObject.Load(50, &t.ipcns)
	stateSourceObject.Load(51, &t.cgroupns)
	stateSourceObject.Load(52, &t.mountNamespace)
	stateSourceObject.Load(53, &t.parentDeathSignal)
	stateSourceObject.Load(55, &t.cleartid)
	stateSourceObject.Load(56, &t.allowedCPUMask)
	stateSourceObject.Load(57, &t.cpu)
	stateSourceObject.Load(58, &t.scheduler)
	stateSourceObject.Load(59, &t.niceness)
	stateSourceObject.Load(60, &t.ioprio)
	stateSourceObject.Load(61, &t.numaPolicy)
	stateSourceObject.Load(62, &t.numaNodeMask)
	stateSourceObject.Load(63, &t.netns)
	stateSourceObject.Load(64, &t.rseqCPU)
	stateSourceObject.Load(65, &t.oldRSeqCPUAddr)
	stateSourceObject.Load(66, &t.rseqAddr)
	stateSourceObject.Load(67, &t.rseqSignature)
	stateSourceObject.Load(68, &t.robustList)
	stateSourceObject.Load(69, &t.startTime)
	stateSourceObject.Load(70, &t.kcov)
	stateSourceObject.Load(71, &t.cgroups)
	stateSourceObject.Load(72, &t.cgroup2)
	stateSourceObject.Load(73, &t.memCgID)
	stateSourceObject.Load(74, &t.userCounters)
	stateSourceObject.Load(75, &t.sessionKeyring)
	stateSourceObject.Load(76, &t.personality)
	stateSourceObject.Load(77, &t.Origin)
	stateSourceObject.Load(78, &t.onDestroyAction)
	stateSourceObject.Load(79, &t.execveCredsMutexOwner)
	stateSourceObject.Load(80, &t.pid)
	stateSourceObject.LoadValue(27, new(*FSContext), func(y any) { t.loadFsContext(ctx, y.(*FSContext)) })
	stateSourceObject.LoadValue(30, new(*Task), func(y any) { t.loadVforkParent(ctx, y.(*Task)) })
	stateSourceObject.LoadValue(36, new(*Task), func(y any) { t.loadPtraceTracer(ctx, y.(*Task)) })
	stateSourceObject.LoadValue(54, new(*taskSeccomp), func(y any) { t.loadSeccomp(ctx, y.(*taskSeccomp)) })
