...
func NewMultiStateFilePagesFileLoader(pagesMetadata, pagesFile *fd.FD) PagesFileLoader {
	...
	go func() {
		...
		pfl.loadResultCh <- pfl.backgroundGoroutine(pagesMetadata, pagesFile)
	}()
	return pfl
}
...
func (pfl *multiStateFilePFL) backgroundGoroutine(pagesMetadataFD, pagesFileFD *fd.FD) error {
