...
const asyncFileClientenableLogging = false

// obj is used to customize logging. Note that we use a pointer to T so that
// we do not copy the entire object when passed as a format parameter.
var asyncFileClientobj *AsyncFileClient
...
//
// +stateify savable
type asyncFileClientRefs struct {
...
// checking.
func (r *asyncFileClientRefs) InitRefs() {
...
func (r *asyncFileClientRefs) RefType() string {
	return fmt.Sprintf("%T", asyncFileClientobj)[1:]
}

// LeakMessage implements refs.CheckedObject.LeakMessage.
func (r *asyncFileClientRefs) LeakMessage() string {
	return fmt.Sprintf("[%s %p] reference count of %d instead of 0", r.RefType(), r, r.ReadRefs())
}

// LogRefs implements refs.CheckedObject.LogRefs.
func (r *asyncFileClientRefs) LogRefs() bool {
	return asyncFileClientenableLogging
}

// ReadRefs returns the current number of references. The returned count is
// inherently racy and is unsafe to use without external synchronization.
func (r *asyncFileClientRefs) ReadRefs() int64 {
...
//
//go:nosplit
func (r *asyncFileClientRefs) IncRef() {
	v := r.refCount.Add(1)
	if asyncFileClientenableLogging {
		refs.LogIncRef(r, v)
	}
	if v <= 1 {
...
//
//go:nosplit
func (r *asyncFileClientRefs) TryIncRef() bool {
...
//
//go:nosplit
func (r *asyncFileClientRefs) DecRef(destroy func()) {
	v := r.refCount.Add(-1)
	if asyncFileClientenableLogging {
		refs.LogDecRef(r, v)
	}
...
func (r *asyncFileClientRefs) afterLoad(context.Context) {
	if r.ReadRefs() > 0 {
		refs.Register(r)
	}
}
