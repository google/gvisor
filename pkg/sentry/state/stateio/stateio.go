...
type AsyncWriter interface {
	...
	// descriptor a valid source for writes to this file, and returns a
	// SourceFile representing it. The returned SourceFile can only be used
	// with the AsyncWriter that returned it. fd does not need to remain valid
	// beyond the call to RegisterSourceFD.
	//
