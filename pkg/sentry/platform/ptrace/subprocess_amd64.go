...
func createSyscallRegs(initRegs *linux.PtraceRegs, sysno uintptr, args ...arch.SyscallArgument) linux.PtraceRegs {
...
func dumpRegs(regs *linux.PtraceRegs) string {
...
func initChildProcessPPID(initregs *linux.PtraceRegs, ppid int32) {
...
func patchSignalInfo(regs *linux.PtraceRegs, signalInfo *arch.SignalInfo) {
