...
const (
	...
	// Pointer authentication key registers (op0=3, op1=0, CRn=2,
	// CRm={1,2,3}). These are only accessible when the vCPU was
	// initialized with the PTRAUTH features.
	_KVM_ARM64_REGS_APIAKEYLO_EL1 = 0x603000000013c108
	_KVM_ARM64_REGS_APIAKEYHI_EL1 = 0x603000000013c109
	_KVM_ARM64_REGS_APIBKEYLO_EL1 = 0x603000000013c10a
	_KVM_ARM64_REGS_APIBKEYHI_EL1 = 0x603000000013c10b
	_KVM_ARM64_REGS_APDAKEYLO_EL1 = 0x603000000013c110
	_KVM_ARM64_REGS_APDAKEYHI_EL1 = 0x603000000013c111
	_KVM_ARM64_REGS_APDBKEYLO_EL1 = 0x603000000013c112
	_KVM_ARM64_REGS_APDBKEYHI_EL1 = 0x603000000013c113
	_KVM_ARM64_REGS_APGAKEYLO_EL1 = 0x603000000013c118
	_KVM_ARM64_REGS_APGAKEYHI_EL1 = 0x603000000013c119
)
...
const (
	...
	_KVM_ARM_VCPU_PTRAUTH_ADDRESS = 5 // vCPU uses address authentication
	_KVM_ARM_VCPU_PTRAUTH_GENERIC = 6 // vCPU uses generic authentication
)
