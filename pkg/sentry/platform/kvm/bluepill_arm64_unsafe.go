...
// dumpExitReason manipulates the provided signal context to capture debugging
// information related to a vCPU exit.
//
// It stores the original instruction pointer in R9 and populates
// registers R10-R14 with the vCPU's exit reason and associated data from
// c.runData. To ensure this information is preserved in a crash report,
// the function intentionally sets RIP to an invalid address (0xabc).
// This forces a memory fault immediately after a sigreturn, triggering a
// crash report that includes the altered register state, providing
// diagnostic details about why the vCPU exited.
//
//go:nosplit
func (c *vCPU) dumpExitReasonSetup(context *arch.SignalContext64) {
