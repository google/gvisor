		...
		v535_104_05 := func() *driverABI {
			...
			return &driverABI{
				frontendIoctl: map[uint32]frontendIoctlHandler{
					...
					nvgpu.NV_ESC_RM_ALLOC_CONTEXT_DMA2:         feHandler(frontendIoctlSimple, nvconf.CapGraphics), // NVOS39_PARAMETERS
					nvgpu.NV_ESC_RM_MAP_MEMORY_DMA:             feHandler(frontendIoctlSimple, nvconf.CapGraphics), // NVOS46_PARAMETERS
					nvgpu.NV_ESC_RM_UNMAP_MEMORY_DMA:           feHandler(frontendIoctlSimple, nvconf.CapGraphics), // NVOS47_PARAMETERS
				...
				controlCmd: map[uint32]controlCmdHandler{
					...
					nvgpu.NV0080_CTRL_CMD_GR_GET_INFO:                                      ctrlHandler(ctrlXxxGetInfo, nvconf.CapGraphics),
					...
					nvgpu.NV2080_CTRL_CMD_FB_GET_INFO:                                      ctrlHandler(ctrlXxxGetInfo, nvconf.CapGraphics),
				...
				allocationClass: map[nvgpu.ClassID]allocationClassHandler{
					...
					nvgpu.NV01_MEMORY_VIRTUAL:        allocHandler(rmAllocSimple[nvgpu.NV_MEMORY_VIRTUAL_ALLOCATION_PARAMS], nvconf.CapGraphics),
