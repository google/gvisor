		...
		v535_104_05 := func() *driverABI {
			...
			return &driverABI{
				...
				controlCmd: map[uint32]controlCmdHandler{
					...
					nvgpu.NV2080_CTRL_CMD_BUS_GET_INFO:                            ctrlHandler(ctrlBusGetInfo, nvconf.CapVideo),
				...
				allocationClass: map[nvgpu.ClassID]allocationClassHandler{
					...
					nvgpu.NVCDB0_VIDEO_DECODER:       allocHandler(rmAllocSimple[nvgpu.NV_BSP_ALLOCATION_PARAMETERS], nvconf.CapVideo),
				...
				getStructs: func() *driverABIStructs {
					return &driverABIStructs{
						...
						controlStructs: map[uint32][]DriverStruct{
							...
							nvgpu.NV2080_CTRL_CMD_BUS_GET_INFO:                                     simpleDriverStruct("NV2080_CTRL_BUS_GET_INFO_PARAMS"),
							...
							nvgpu.NV0080_CTRL_CMD_GR_GET_CAPS_V2:                                   simpleDriverStruct("NV0080_CTRL_GR_GET_CAPS_PARAMS_V2"),
							...
							nvgpu.NV0080_CTRL_CMD_FIFO_GET_CAPS_V2:                                 simpleDriverStruct("NV0080_CTRL_FIFO_GET_CAPS_PARAMS_V2"),
						...
						allocationStructs: map[nvgpu.ClassID][]DriverStruct{
							...
							nvgpu.NVENC_SW_SESSION:           driverStructs(nvgpu.NVA0BC_ALLOC_PARAMETERS{}),
							...
							nvgpu.NVCDB0_VIDEO_DECODER:       driverStructs(nvgpu.NV_BSP_ALLOCATION_PARAMETERS{}),
