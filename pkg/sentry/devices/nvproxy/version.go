		...
		v535_104_05 := func() *driverABI {
			...
			return &driverABI{
				frontendIoctl: map[uint32]frontendIoctlHandler{
					...
					nvgpu.NV_ESC_RM_ALLOC_MEMORY:               feHandler(rmAllocMemory, compUtil|nvconf.CapGraphics|nvconf.CapVideo),
				...
				controlCmd: map[uint32]controlCmdHandler{
					...
					nvgpu.NV2080_CTRL_CMD_BUS_GET_INFO:                            ctrlHandler(rmControlSimple, nvconf.CapVideo),
					...
					nvgpu.NV0080_CTRL_CMD_GR_GET_CAPS_V2:                                   ctrlHandler(rmControlSimple, nvconf.CapGraphics),
				...
				allocationClass: map[nvgpu.ClassID]allocationClassHandler{
					...
					nvgpu.NVENC_SW_SESSION:           allocHandler(rmAllocSimple[nvgpu.NVA0BC_ALLOC_PARAMETERS], nvconf.CapVideo),
				...
				getStructNames: func() *driverStructNames {
					return &driverStructNames{
						...
						controlNames: map[uint32][]DriverStruct{
							...
							nvgpu.NV2080_CTRL_CMD_BUS_GET_INFO:                                     simpleIoctl("NV2080_CTRL_BUS_GET_INFO_PARAMS"), // TODO: Difference with V2 is alignment. Look into this.
							...
							nvgpu.NV2080_CTRL_CMD_GPU_GET_ENCODER_CAPACITY:                         simpleIoctl("NV2080_CTRL_GPU_GET_ENCODER_CAPACITY_PARAMS"),
							...
							nvgpu.NV0080_CTRL_CMD_GR_GET_CAPS_V2:                                   simpleIoctl("NV0080_CTRL_GR_GET_CAPS_PARAMS_V2"),
							...
							nvgpu.NV0080_CTRL_CMD_FIFO_GET_CAPS_V2:                                 simpleIoctl("NV0080_CTRL_FIFO_GET_CAPS_PARAMS_V2"),
						...
						allocationNames: map[nvgpu.ClassID][]DriverStruct{
							...
							nvgpu.NV01_CONTEXT_DMA:           getStructName(nvgpu.NV_CONTEXT_DMA_ALLOCATION_PARAMS{}),
							...
							nvgpu.NVENC_SW_SESSION:           getStructName(nvgpu.NVA0BC_ALLOC_PARAMETERS{}),
							...
							nvgpu.NVC4B0_VIDEO_DECODER:       getStructName(nvgpu.NV_BSP_ALLOCATION_PARAMETERS{}),
							nvgpu.NVC4B7_VIDEO_ENCODER:       getStructName(nvgpu.NV_MSENC_ALLOCATION_PARAMETERS{}),
