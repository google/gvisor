		...
		v535_104_05 := func() *driverABI {
			...
			return &driverABI{
				...
				controlCmd: map[uint32]controlCmdHandler{
					...
					nvgpu.NV2080_CTRL_CMD_GPU_EXEC_REG_OPS:                                 ctrlHandler(ctrlGpuExecRegOps, compUtil),
					...
					nvgpu.NV90CC_CTRL_CMD_POWER_REQUEST_FEATURES:                           ctrlHandler(rmControlSimple, compUtil),
