		...
		v535_104_05 := func() *driverABI {
			...
			return &driverABI{
				...
				controlCmd: map[uint32]controlCmdHandler{
					...
					nvgpu.NV2080_CTRL_CMD_GR_GET_SM_TO_GPC_TPC_MAPPINGS:                    ctrlHandler(rmControlSimple, compUtil),
					...
					nvgpu.NVB0CC_CTRL_CMD_RESERVE_CCU_PROF:                                 ctrlHandler(rmControlSimple, nvconf.CapProfiling),
					...
					nvgpu.NVA06C_CTRL_CMD_GET_TIMESLICE:                                    ctrlHandler(rmControlSimple, compUtil),
					...
					nvgpu.NV2080_CTRL_CMD_FB_FLUSH_GPU_CACHE:                               ctrlHandler(rmControlSimple, compUtil),
				...
				getInfo: func() *DriverABIInfo {
					return &DriverABIInfo{
						...
						ControlInfos: map[uint32]IoctlInfo{
							...
							nvgpu.NVB0CC_CTRL_CMD_RESERVE_CCU_PROF:                                 simpleIoctlInfo("NVB0CC_CTRL_CMD_RESERVE_CCU_PROF", "NVB0CC_CTRL_RESERVE_CCUPROF_PARAMS"),
