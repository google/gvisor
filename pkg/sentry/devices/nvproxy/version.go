...
func Init() {
	abisOnce.Do(func() {
		v535_104_05 := func() *driverABI {
			...
			return &driverABI{
				frontendIoctl: map[uint32]frontendIoctlHandler{
					...
					nvgpu.NV_ESC_CHECK_VERSION_STR:             feHandler(frontendIoctlSimple, compUtil), // nv_ioctl_rm_api_version_t
					...
					nvgpu.NV_ESC_RM_DUP_OBJECT:                 feHandler(frontendIoctHasStatus[nvgpu.NVOS55Parameters], compUtil),
					nvgpu.NV_ESC_RM_SHARE:                      feHandler(frontendIoctHasStatus[nvgpu.NVOS57Parameters], compUtil),
					nvgpu.NV_ESC_RM_UNMAP_MEMORY:               feHandler(frontendIoctHasStatus[nvgpu.NVOS34Parameters], compUtil),
					nvgpu.NV_ESC_RM_UPDATE_DEVICE_MAPPING_INFO: feHandler(frontendIoctHasStatus[nvgpu.NVOS56Parameters], compUtil),
		...
		v550_40_07 := func() *driverABI {
			abi := v545_23_06()
			abi.frontendIoctl[nvgpu.NV_ESC_WAIT_OPEN_COMPLETE] = feHandler(frontendIoctHasStatus[nvgpu.IoctlWaitOpenComplete], compUtil) // nv_ioctl_wait_open_complete_t
