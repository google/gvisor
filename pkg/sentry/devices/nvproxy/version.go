	...
	abisOnce.Do(func() {
		...
		v570_86_15 := addDriverABI(570, 86, 15, "87709c19c7401243136bc0ec9e7f147c6803070a11449ae8f0819dee7963f76b", ChecksumNoDriver, func() *driverABI {
			...
			abi.getInfo = func() *DriverABIInfo {
				...
				info.ControlInfos[nvgpu.NV2080_CTRL_CMD_FB_QUERY_DRAM_ENCRYPTION_STATUS] = simpleIoctlInfo("NV2080_CTRL_CMD_FB_QUERY_DRAM_ENCRYPTION_STATUS", "NV2080_CTRL_FB_DRAM_ENCRYPTION_STATUS_PARAMS")
		...
		v575_51_02 := func() *driverABI {
			...
			abi.getInfo = func() *DriverABIInfo {
				...
				info.ControlInfos[nvgpu.NV2080_CTRL_CMD_FB_QUERY_DRAM_ENCRYPTION_STATUS_575_51_02] = simpleIoctlInfo("NV2080_CTRL_CMD_FB_QUERY_DRAM_ENCRYPTION_STATUS", "NV2080_CTRL_FB_DRAM_ENCRYPTION_STATUS_PARAMS")
