...
// StatAt is a convenience wrapper around fstatat(2). LoongArch uses the
// asm-generic syscall table, so unix.SYS_FSTATAT resolves to the same
// number (79) as on arm64; the implementation matches verbatim.
