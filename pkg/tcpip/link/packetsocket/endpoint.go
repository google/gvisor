...
func (e *endpoint) WritePacket(r stack.NetworkPacketInfo, gso *stack.GSO, protocol tcpip.NetworkProtocolNumber, pkt *stack.PacketBuffer) *tcpip.Error {
	e.Endpoint.DeliverOutboundPacket(pkt.LinkPacketInfo.RemoteLinkAddress, pkt.LinkPacketInfo.LocalLinkAddress, protocol, pkt)
	return e.Endpoint.WritePacket(r, gso, protocol, pkt)
}

// WritePackets implements stack.LinkEndpoint.WritePackets.
func (e *endpoint) WritePackets(r stack.NetworkPacketInfo, gso *stack.GSO, pkts stack.PacketBufferList, proto tcpip.NetworkProtocolNumber) (int, *tcpip.Error) {
	for pkt := pkts.Front(); pkt != nil; pkt = pkt.Next() {
		e.Endpoint.DeliverOutboundPacket(pkt.LinkPacketInfo.RemoteLinkAddress, pkt.LinkPacketInfo.LocalLinkAddress, pkt.NetworkProtocolNumber, pkt)
	}
