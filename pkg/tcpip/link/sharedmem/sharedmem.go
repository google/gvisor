...
func (e *endpoint) WritePacket(r stack.NetworkPacketInfo, _ *stack.GSO, protocol tcpip.NetworkProtocolNumber, pkt *stack.PacketBuffer) *tcpip.Error {
	e.AddHeader(pkt.LinkPacketInfo.LocalLinkAddress, pkt.LinkPacketInfo.RemoteLinkAddress, protocol, pkt)
...
func (*endpoint) WritePackets(stack.NetworkPacketInfo, *stack.GSO, stack.PacketBufferList, tcpip.NetworkProtocolNumber) (int, *tcpip.Error) {
