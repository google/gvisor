...
func (e *endpoint) WritePacket(_ *stack.GSO, pkt *stack.PacketBuffer) *tcpip.Error {
	e.AddHeader(pkt.LinkPacketInfo.LocalLinkAddress, pkt.LinkPacketInfo.RemoteLinkAddress, pkt.NetworkProtocolNumber, pkt)
