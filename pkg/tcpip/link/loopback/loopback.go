...
func (e *endpoint) WritePacket(_ stack.NetworkPacketInfo, _ *stack.GSO, protocol tcpip.NetworkProtocolNumber, pkt *stack.PacketBuffer) *tcpip.Error {
...
func (e *endpoint) WritePackets(stack.NetworkPacketInfo, *stack.GSO, stack.PacketBufferList, tcpip.NetworkProtocolNumber) (int, *tcpip.Error) {
