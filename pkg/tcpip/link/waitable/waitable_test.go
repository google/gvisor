...
func (e *countedEndpoint) WritePacket(r *stack.Route, _ *stack.GSO, hdr buffer.Prependable, payload buffer.VectorisedView, protocol tcpip.NetworkProtocolNumber, priority uint32) *tcpip.Error {
	e.writeCount++
	return nil
}

// WritePackets implements stack.LinkEndpoint.WritePackets.
func (e *countedEndpoint) WritePackets(r *stack.Route, _ *stack.GSO, hdrs []stack.PacketDescriptor, payload buffer.VectorisedView, protocol tcpip.NetworkProtocolNumber, priority uint32) (int, *tcpip.Error) {
	e.writeCount += len(hdrs)
	return len(hdrs), nil
}

func (e *countedEndpoint) WriteRawPacket(packet buffer.VectorisedView, priority uint32) *tcpip.Error {
	e.writeCount++
	return nil
}
...
func TestWaitWrite(t *testing.T) {
	...
	wep.WritePacket(nil, nil /* gso */, buffer.Prependable{}, buffer.VectorisedView{}, 0, stack.DefaultPriority)
