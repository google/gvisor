...
func (e *countedEndpoint) WritePacket(*stack.GSO, *stack.PacketBuffer) *tcpip.Error {
	e.writeCount++
	return nil
}

// WritePackets implements stack.LinkEndpoint.WritePackets.
func (e *countedEndpoint) WritePackets(_ *stack.GSO, pkts stack.PacketBufferList) (int, *tcpip.Error) {
...
func TestWaitWrite(t *testing.T) {
	...
	wep.WritePacket(nil /* gso */, stack.NewPacketBuffer(stack.PacketBufferOptions{}))
