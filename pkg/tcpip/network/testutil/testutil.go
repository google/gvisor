...
func (ep *MockLinkEndpoint) WritePacket(_ stack.NetworkPacketInfo, _ *stack.GSO, _ tcpip.NetworkProtocolNumber, pkt *stack.PacketBuffer) *tcpip.Error {
...
func (ep *MockLinkEndpoint) WritePackets(r stack.NetworkPacketInfo, gso *stack.GSO, pkts stack.PacketBufferList, protocol tcpip.NetworkProtocolNumber) (int, *tcpip.Error) {
	var n int
