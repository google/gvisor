...
// lookupConntrackRevision validates if a conntrack match revision is supported and returns the best revision.
// Ref: net/netfilter/xt_conntrack.c:conntrack_mt_reg, net/netfilter/x_tables.c:xt_find_revision
