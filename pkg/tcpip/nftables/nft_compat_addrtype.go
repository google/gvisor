...
// lookupAddrtypeRevision validates if an addrtype match revision is supported and returns the best revision.
// Ref: net/netfilter/xt_addrtype.c:addrtype_mt_reg, net/netfilter/x_tables.c:xt_find_revision
