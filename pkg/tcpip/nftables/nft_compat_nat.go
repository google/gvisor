...
// lookupNATRevision validates if an SNAT or DNAT target revision is supported
...
// Ref: net/netfilter/xt_nat.c:xt_nat_target_reg, net/netfilter/x_tables.c:xt_check_target
