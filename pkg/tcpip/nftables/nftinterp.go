...
func validateIdentifier(id string, lnIdx int, tkIdx int) *syserr.Error {
...
func InterpretRule(ruleString string) (*Rule, *syserr.Error) {
...
// binary (can be accomplished by using flag --debug=netlink).
func InterpretOperation(line string, lnIdx int) (operation, *syserr.Error) {
...
func InterpretImmediate(line string, lnIdx int) (operation, *syserr.Error) {
	tokens := strings.Fields(line)
...
func InterpretComparison(line string, lnIdx int) (operation, *syserr.Error) {
	tokens := strings.Fields(line)
...
// string.
func InterpretPayloadLoad(line string, lnIdx int) (operation, *syserr.Error) {
	tokens := strings.Fields(line)
...
func InterpretPayloadSet(line string, lnIdx int) (operation, *syserr.Error) {
	tokens := strings.Fields(line)
...
func InterpretBitwiseBool(line string, lnIdx int) (operation, *syserr.Error) {
	tokens := strings.Fields(line)
...
func InterpretCounter(line string, lnIdx int) (operation, *syserr.Error) {
	tokens := strings.Fields(line)
...
func InterpretRoute(line string, lnIdx int) (operation, *syserr.Error) {
	tokens := strings.Fields(line)
...
func InterpretByteorder(line string, lnIdx int) (operation, *syserr.Error) {
	tokens := strings.Fields(line)
...
func InterpretMetaLoad(line string, lnIdx int) (operation, *syserr.Error) {
	tokens := strings.Fields(line)
...
func InterpretMetaSet(line string, lnIdx int) (operation, *syserr.Error) {
	tokens := strings.Fields(line)
...
// square brackets.
func checkOperationBrackets(tokens []string, lnIdx int) *syserr.Error {
	if tokens[0] != "[" {
		return syserr.ErrInvalidArgument
	}
...
func parseUint8(regString string, supposed string, lnIdx int, tkIdx int) (uint8, *syserr.Error) {
	var v64 uint64
	var err error
...
func parseRegister(regString string, lnIdx int, tkIdx int) (uint8, *syserr.Error) {
...
func parseRegisterData(reg uint8, tokens []string, lnIdx int, tkIdx int) (int, registerData, *syserr.Error) {
...
// the index of the next token to process (can consume multiple tokens).
func parseVerdict(tokens []string, lnIdx int, tkIdx int) (int, stack.NFVerdict, *syserr.Error) {
	v := stack.NFVerdict{}

	vcString := tokens[tkIdx]
	vc, ok := verdictCodeFromKeyword[vcString]
	if !ok {
		return 0, v, syserr.ErrInvalidArgument
	}
	v.Code = VC(vc)
	tkIdx++
...
func parseHexData(tokens []string, lnIdx int, tkIdx int) (int, []byte, *syserr.Error) {
	var bytes []byte
...
func parseCmpOp(copString string, lnIdx int, tkIdx int) (int, *syserr.Error) {
...
// the given string.
func parseUint8PlusChar(numString string, char byte, lnIdx int, tkIdx int) (uint8, *syserr.Error) {
...
func parsePayloadBase(baseString string, lnIdx int, tkIdx int) (payloadBase, *syserr.Error) {
...
func parseRouteKey(keyString string, lnIdx int, tkIdx int) (routeKey, *syserr.Error) {
...
func parseMetaKey(keyString string, lnIdx int, tkIdx int) (metaKey, *syserr.Error) {
...
func consumeToken(expected string, tokens []string, lnIdx int, tkIdx int) *syserr.Error {
