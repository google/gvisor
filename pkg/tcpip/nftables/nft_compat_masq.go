...
// lookupMasqRevision validates if a masquerade target revision is supported and returns the best revision.
// Ref: net/netfilter/xt_MASQUERADE.c:masquerade_tg_reg, net/netfilter/x_tables.c:xt_find_revision
