...
type PacketBuffer struct {
	...
	// RXTransportChecksumValidated indicates that transport layer checksum
	// verification has already been performed on receeived packets and that
	// it's safe for the stack to skip transport layer checksum verification.
...
// CloneToInbound makes a shallow copy of the packet buffer to be received by
// the stack.
