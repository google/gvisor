...
// PacketBufferPtr is a "smart" pointer to a PacketBuffer. It cannot be used to
// call DecRef more than once.
//
// +stateify savable
type PacketBufferPtr struct {
	// packetBuffer is the underlying packet buffer.
	*packetBuffer
	// ticket can be used to DecRef no more than once.
	ticket Ticket
}
...
// pool.
//
// DecRef also zeroes the pointer, making it unusable after decrementing. This
// is to make use-after-free bugs panic early.
