...
type fwdTestNetworkProtocol struct {
	...
	onLinkAddressResolved  func(cache *neighborCache, addr tcpip.Address, remoteLinkAddr tcpip.LinkAddress)
...
func (f *fwdTestNetworkProtocol) NewEndpoint(nicID tcpip.NICID, _ NUDHandler, dispatcher TransportDispatcher, ep LinkEndpoint, _ *Stack) NetworkEndpoint {
