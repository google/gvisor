...
func TestAddressRemoval(t *testing.T) {
	...
	if err != tcpip.ErrBadLocalAddress {
...
func TestGetMainNICAddressErrors(t *testing.T) {
	...
	switch addr, err := s.GetMainNICAddress(unknownNICID, ipv4.ProtocolNumber); err {
	...
	switch addr, err := s.GetMainNICAddress(nicID, arp.ProtocolNumber); err {
	...
	switch addr, err := s.GetMainNICAddress(nicID, unknownProtocolNumber); err {
