...
func (f *fakeNetworkProtocol) NewEndpoint(nicID tcpip.NICID, _ stack.NUDHandler, dispatcher stack.TransportDispatcher, ep stack.LinkEndpoint, _ *stack.Stack) stack.NetworkEndpoint {
