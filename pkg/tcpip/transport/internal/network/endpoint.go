...
func (e *Endpoint) SetSockOptInt(opt tcpip.SockOptInt, v int) tcpip.Error {
	...
	case tcpip.MTUDiscoverOption:
		e.sockOptStats.SetMTUDiscoverOption.Increment()
	...
	case tcpip.MulticastTTLOption:
		e.sockOptStats.SetMulticastTTLOption.Increment()
		e.mu.Lock()
		e.multicastTTL = uint8(v)
		e.mu.Unlock()

	case tcpip.IPv4TTLOption:
		e.sockOptStats.SetIPv4TTLOption.Increment()
		e.mu.Lock()
		e.ipv4TTL = uint8(v)
		e.mu.Unlock()

	case tcpip.IPv6HopLimitOption:
		e.sockOptStats.SetIPv6HopLimitOption.Increment()
		e.mu.Lock()
		e.ipv6HopLimit = int16(v)
		e.mu.Unlock()

	case tcpip.IPv4TOSOption:
		e.sockOptStats.SetIPv4TOSOption.Increment()
		e.mu.Lock()
		e.ipv4TOS = uint8(v)
		e.mu.Unlock()

	case tcpip.IPv6TrafficClassOption:
		e.sockOptStats.SetIPv6TrafficClassOption.Increment()
		e.mu.Lock()
...
func (e *Endpoint) GetSockOptInt(opt tcpip.SockOptInt) (int, tcpip.Error) {
	switch opt {
	case tcpip.MTUDiscoverOption:
		e.sockOptStats.GetMTUDiscoverOption.Increment()
		// The only supported setting is path MTU discovery disabled.
		return tcpip.PMTUDiscoveryDont, nil

	case tcpip.MulticastTTLOption:
		e.sockOptStats.GetMulticastTTLOption.Increment()
		e.mu.Lock()
	...
	case tcpip.IPv4TTLOption:
		e.sockOptStats.GetIPv4TTLOption.Increment()
		e.mu.Lock()
		v := int(e.ipv4TTL)
		e.mu.Unlock()
		return v, nil
	...
	case tcpip.IPv6HopLimitOption:
		e.sockOptStats.GetIPv6HopLimitOption.Increment()
		e.mu.Lock()
	...
	case tcpip.IPv4TOSOption:
		e.sockOptStats.GetIPv4TOSOption.Increment()
		e.mu.RLock()
		v := int(e.ipv4TOS)
		e.mu.RUnlock()
		return v, nil
	...
	case tcpip.IPv6TrafficClassOption:
		e.sockOptStats.GetIPv6TrafficClassOption.Increment()
		e.mu.RLock()
		v := int(e.ipv6TClass)
		e.mu.RUnlock()
		return v, nil
...
func (e *Endpoint) SetSockOpt(opt tcpip.SettableSocketOption) tcpip.Error {
	...
	case *tcpip.MulticastInterfaceOption:
		e.sockOptStats.SetMulticastInterfaceOption.Increment()
		e.mu.Lock()
		defer e.mu.Unlock()
	...
	case *tcpip.AddMembershipOption:
		e.sockOptStats.SetAddMembershipOption.Increment()
	...
	case *tcpip.RemoveMembershipOption:
		e.sockOptStats.SetRemoveMembershipOption.Increment()
		if !(header.IsV4MulticastAddress(v.MulticastAddr) && e.netProto == header.IPv4ProtocolNumber) && !(header.IsV6MulticastAddress(v.MulticastAddr) && e.netProto == header.IPv6ProtocolNumber) {
			return &tcpip.ErrInvalidOptionValue{}
		}
...
func (e *Endpoint) GetSockOpt(opt tcpip.GettableSocketOption) tcpip.Error {
	switch o := opt.(type) {
	case *tcpip.MulticastInterfaceOption:
		e.sockOptStats.GetMulticastInterfaceOption.Increment()
		e.mu.Lock()
