...
type keepalive struct {
	...
	// sufficient. It should never be a zero timer if the endpoint is not closed.
...
// closePendingAcceptableConnectionsLocked closes connections that have completed
