...
func (e *endpoint) HandleControlPacket(_ stack.TransportEndpointID, typ stack.ControlType, extra uint32, _ *stack.PacketBuffer) {
	switch typ {
	...
	case stack.ControlNoRoute:
		e.updateLastError(tcpip.ErrNoRoute)
