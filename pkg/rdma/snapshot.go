...
// bdfRE matches a PCI function directory name ("0000:0c:00.0"). The domain
// is at least 4 hex digits: the kernel prints it with %04x, and synthetic
// domains above 0xffff (e.g. Intel VMD) print wider.
