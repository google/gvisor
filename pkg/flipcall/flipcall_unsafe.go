...
func (ep *Endpoint) connState() *atomic.Uint32 {
	return (*atomic.Uint32)(unsafe.Pointer(ep.packet))
}

func (ep *Endpoint) dataLen() *atomic.Uint32 {
	return (*atomic.Uint32)(unsafe.Pointer(ep.packet + 4))
}
